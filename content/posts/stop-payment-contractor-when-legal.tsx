export default function Post() {
  return (
    <>
      <p>
        Withholding payment from a contractor is sometimes the right move &mdash; and sometimes it makes you the party in breach of contract. The line between justified withholding and wrongful payment refusal is defined by your contract, the facts on the ground, and your state&apos;s construction law. Getting this wrong can flip a situation where you have legitimate grievances into one where the contractor has legal claims against you.
      </p>
      <p>
        Understanding when payment withholding is legally justified &mdash; and what steps to take before stopping payment &mdash; protects you from creating new problems while addressing the original one.
      </p>

      <h2>When is withholding payment from a contractor legally justified?</h2>
      <p>
      ...
      <h2>What are the risks of withholding payment without proper justification?</h2>
      <p>
      ...
      <p>
        Courts in most jurisdictions take a dim view of payment withholding that is not supported by clear documentation of the contractual basis for the withholding. &ldquo;I didn&apos;t like the work&rdquo; is not sufficient. &ldquo;The work did not meet the specification in Section 3.2 of the contract, as documented by these photographs taken on [date]&rdquo; is.
      </p>

      <h2>What steps should I take before withholding a payment?</h2>
      <p>
      ...
      <h2>Can I stop payment on a check already written to a contractor?</h2>
      <p>
        You can place a stop payment order with your bank on a check that has not yet cleared, but this must be done promptly &mdash; checks typically clear within 1&ndash;3 business days. The bank will charge a stop payment fee (typically $25&ndash;35). Note that a stop payment is a temporary measure &mdash; the contractor retains the right to sue you for the amount of the check unless you have legitimate grounds to withhold it.
      </p>
      <p>
      ...
      <h2>How does contractor licensing affect payment withholding situations?</h2>
      <p>
