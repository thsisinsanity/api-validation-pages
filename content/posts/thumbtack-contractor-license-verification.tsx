export default function Post() {
  return (
    <>
      ...
      <p>
        Understanding exactly what Thumbtack verifies &mdash; and what it leaves up to you &mdash; helps you use the platform wisely.
      </p>

      <h2>How does Thumbtack handle contractor license verification?</h2>
      <p>
        Thumbtack offers a &ldquo;Background Checked&rdquo; badge for service professionals who have completed their background check process. This badge indicates identity verification and a criminal background check. It does not independently verify contractor license status in the way a state licensing board lookup would.
      </p>
      <p>
        Thumbtack allows professionals to self-report license and certification information on their profiles. A contractor can claim to be licensed and display a license number on their Thumbtack profile, but Thumbtack does not verify this information against state licensing board databases. The &ldquo;Pro&rdquo; designation on Thumbtack reflects engagement with the platform and review quality, not licensing compliance.
      </p>

      <h2>What does Thumbtack&apos;s &ldquo;Background Checked&rdquo; badge actually mean?</h2>
      <p>
        The badge confirms that the professional completed Thumbtack&apos;s background check process, which typically includes identity verification and a criminal record search through a third-party screening company. This is a meaningful check &mdash; it creates accountability and filters out professionals with significant criminal histories.
      </p>
      <p>
      ...
      <h2>Why does Thumbtack&apos;s model create verification gaps?</h2>
      <p>
        Thumbtack operates as a marketplace, connecting supply (professionals) with demand (homeowners) at scale. Their screening is designed to establish basic trust and safety, not to replicate the comprehensive verification that state licensing boards perform. The economics of a marketplace platform don&apos;t favor deep individual vetting of every professional &mdash; the volume and speed of the platform would be incompatible with a licensing-board-level review of each contractor.
      </p>
      <p>
        This is not a criticism of Thumbtack specifically &mdash; it applies equally to virtually every gig and marketplace platform. The design goal is efficient matching, and that goal is different from the homeowner&apos;s goal of comprehensive contractor verification.
      </p>

      <h2>What contractor categories on Thumbtack are most at risk for licensing gaps?</h2>
      <p>
        Higher-risk categories include electrical work, plumbing, HVAC, roofing, and structural work &mdash; trades where licensing is mandatory in most states and where unlicensed work creates the most significant safety and legal risk. Smaller-dollar, lower-stakes services like pressure washing or handyman work carry different risk profiles.
      </p>
      <p>
        For any work where a state license is legally required, the homeowner needs to verify that license independently &mdash; not just accept the contractor&apos;s self-reported claim on their Thumbtack profile.
      </p>

      <h2>How do I verify a Thumbtack contractor&apos;s license before hiring?</h2>
      <p>
