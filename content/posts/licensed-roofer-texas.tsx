export default function Post() {
  return (
    <>
      <p>
        Texas is one of the few states that does not require roofers to hold a statewide license. That might sound like a minor detail &mdash; but it has major implications for homeowners. Without a statewide licensing requirement, almost anyone can call themselves a roofing contractor in Texas, which means verifying credentials and doing your homework is more important here than in almost any other state.
      </p>

      <h2>Does Texas require roofers to be licensed?</h2>
      <p>
      ...
      <h2>Why does the lack of a statewide license matter to homeowners?</h2>
      <p>
      ...
      <p>
        Texas is particularly vulnerable to storm-chasing contractors &mdash; out-of-state operators who flood the market after hurricanes, hailstorms, and tornadoes. These contractors often collect insurance deposits upfront, perform poor-quality work, and then leave the state before problems surface. Without licensing, there is no state agency tracking their credentials or fielding complaints about their work.
      </p>
      <p>
        The Insurance Council of Texas and local consumer protection agencies have repeatedly cited unlicensed roofing fraud as a major problem following major weather events. After Hurricane Harvey in 2017, the Texas Attorney General&apos;s office received 684 scam complaints within just four days of landfall. The Roofing Contractors Association of Texas (RCAT) has since launched the Safe Roofs Over Texas initiative, pushing for legislation requiring all roofers to provide verified identification and a physical address before beginning work.
      </p>

      <h2>How do you verify a roofer&apos;s credentials in Texas?</h2>
      <p>
        Because there is no statewide license to check, verifying a Texas roofer requires a different approach. Start by checking whether your city or county requires local registration or a permit for roofing work &mdash; if so, confirm the contractor is registered. Contact your local permitting office or city website for current requirements.
      </p>
      <p>
      ...
      <h2>What bond and insurance should a Texas roofer carry?</h2>
      <p>
        Texas does not require roofers to carry a bond, since there is no statewide licensing requirement to enforce bond obligations. However, reputable roofers should voluntarily carry general liability insurance (typically $1 million or more per occurrence) and workers&apos; compensation insurance if they have employees. The Texas Department of Insurance has issued fines exceeding $5,000 to contractors who violate deductible-related laws &mdash; a common tactic in roofing fraud where contractors offer to &quot;waive your deductible&quot; in exchange for signing over the insurance claim.
      </p>
      <p>
        Without workers&apos; comp, a worker injured on your property could have grounds to pursue compensation through your homeowner&apos;s insurance or a personal injury claim against you. This risk is real and documented &mdash; Texas is the only state that does not require most private employers to carry workers&apos; compensation insurance, making it especially important to verify coverage yourself.
      </p>
      <p>
