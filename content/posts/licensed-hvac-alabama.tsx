export default function Post() {
  return (
    <>
      ...
      <h2>Where do I verify an Alabama HVAC contractor&apos;s license?</h2>
      <p>
        Search the Alabama Electrical Contractors Board license verification portal at aecb.alabama.gov. Select the HVAC-related license type and search by company name or license number. The result will show current license status and expiration date. An active license with a future expiration date is the baseline. For EPA 608, ask the contractor to provide their certification card &mdash; there is no single national lookup for 608 credentials.
      </p>
      <p>
      ...
      <h2>What does EPA Section 608 certification mean for HVAC work?</h2>
      <p>
      ...
      <p>
        This requirement exists because refrigerants like R-410A and older R-22 are regulated substances. Improper handling contributes to ozone depletion and presents safety risks. A contractor without EPA 608 who works on your system is cutting corners that carry federal enforcement consequences &mdash; not just a licensing issue, but a regulatory violation.
      </p>

      <h2>What bond requirements apply to Alabama HVAC contractors?</h2>
      <p>
