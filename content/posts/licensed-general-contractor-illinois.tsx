export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Illinois: How to Verify Before You Hire</h1>
      ...
      <h2>What Are Chicago&apos;s General Contractor Licensing Requirements?</h2>

      <p>
        The City of Chicago requires general contractors to hold a <strong>City of Chicago General Contractor license</strong> issued by the Department of Buildings. Chicago&apos;s licensing is separate from and in addition to any IDFPR requirements. Chicago GC licensees must pass an exam, demonstrate experience, carry insurance, and renew their license annually. The City of Chicago also requires specialty licenses for electrical, plumbing, and HVAC work performed within city limits.
      </p>
      ...
      <h2>What Insurance and Bond Should an Illinois GC Carry?</h2>
      ...
      <h2>How Do You Verify a General Contractor&apos;s License in Illinois?</h2>

      <p>
        For IDFPR-licensed trades (including roofing), verify at idfpr.illinois.gov. For Chicago projects, verify at the City of Chicago Department of Buildings website. For municipalities outside Chicago &mdash; suburbs like Naperville, Evanston, or Rockford &mdash; contact the local building department directly to confirm what licensing requirements apply.
      </p>
