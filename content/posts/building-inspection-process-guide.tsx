export default function Post() {
  return (
    <>
      <p>
        A building inspection is an independent review of construction work by a certified government inspector who confirms the work meets local building codes. Inspections happen at specific stages of a project before the work is covered &mdash; because once drywall goes up, no one can verify the wiring or plumbing without tearing it down. Understanding what inspectors check and how to prepare helps your project move through the process smoothly.
      </p>
      <p>
      ...
      <h2>What do building inspectors actually check?</h2>
      <p>
      ...
      <p>
        Inspectors do not evaluate aesthetics &mdash; they check code compliance. A beautifully finished basement with dangerously undersized wiring will pass inspection on appearance and fail on safety. Inspectors focus on life-safety and structural issues: proper wire gauge, ground fault protection, water heater pressure relief, structural connections, and similar code-required items.
      </p>

      <h2>How do I schedule a building inspection?</h2>
      <p>
        Your contractor schedules inspections by contacting the local building department and requesting an inspection for the appropriate phase of work. In most jurisdictions, inspection requests are made online or by phone 24&ndash;48 hours in advance. The building department assigns a date and time window (usually a half-day window like &ldquo;morning&rdquo; or &ldquo;afternoon&rdquo;). The contractor should be present during the inspection.
      </p>
      <p>
        As the homeowner, you have the right to be present during any inspection. This is often worth doing, especially for complex projects &mdash; you can hear directly from the inspector what passed, what failed, and what the correction involves.
      </p>

      <h2>What happens when an inspection fails?</h2>
      <p>
      ...
      <h2>Can I look up inspection history for my home?</h2>
      <p>
      ...
      <h2>What should I do if my contractor refuses to schedule required inspections?</h2>
      <p>
