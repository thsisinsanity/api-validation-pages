export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in New York: How to Verify Before You Hire</h1>

      <p>
        New York State requires home improvement contractors to register under the <strong>Home Improvement Contractor (HIC) program</strong> administered by the New York Department of State (DOS) at dos.ny.gov. However, New York City operates its own separate licensing system with additional requirements &mdash; making New York one of the most complex contractor licensing landscapes in the country.
      </p>

      <h2>What Is New York&apos;s Home Improvement Contractor Registration?</h2>

      <p>
        New York State&apos;s HIC registration is mandatory for contractors performing home improvement work &mdash; any work on a one- or two-family residence, condominium, or cooperative apartment. Registration is handled by the Department of State and requires contractors to post a $25,000 bond or deposit, carry general liability insurance, and complete a registration application. Unlike a full licensing exam, HIC registration does not require a skills test, but it does create a paper trail and a bond that consumers can claim against.
      </p>

      <p>
        The New York HIC law covers most residential contractors including general contractors, remodelers, and home improvement specialists. Work that is purely commercial or that exceeds the definition of &ldquo;home improvement&rdquo; may fall under different requirements. For residential work in New York State outside of NYC, confirm the contractor is registered through the DOS system at dos.ny.gov.
      </p>
      ...
      <h2>What Are New York City&apos;s Separate Contractor Requirements?</h2>
      ...
      <h2>What Bond Does a New York Home Improvement Contractor Need?</h2>

      <p>
        New York State HIC registration requires contractors to either post a <strong>$25,000 surety bond</strong> or make a deposit into a state fund. The bond protects consumers if the contractor abandons a project, fails to complete work, or violates the contract terms. NYC DCWP has its own bond requirements for city-licensed contractors on top of the state requirement.
      </p>
      ...
      <h2>How Do You Verify a New York General Contractor&apos;s Registration?</h2>
