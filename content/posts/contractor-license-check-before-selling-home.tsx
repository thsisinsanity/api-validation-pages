export default function Post() {
  return (
    <>
      ...
      <h2>What disclosure requirements apply to contractor work when selling a home?</h2>
      <p>
      ...
      <p>
        The operative word is &ldquo;known.&rdquo; You are generally not required to investigate work done before you owned the home. But if you hired contractors and you know whether permits were pulled, you are on the hook for that knowledge. Many sellers in good faith simply don&apos;t know &mdash; which is why reviewing permit records before listing protects you.
      </p>

      <h2>How do unpermitted additions affect a home sale?</h2>
      <p>
      ...
      <p>
        A 2021 survey by the National Association of Realtors found that unpermitted work was cited as a deal-killer in approximately 8% of real estate transactions where it was discovered. Even when deals survive, sellers typically take a price reduction of 5&ndash;15% to compensate buyers for the risk of unpermitted work.
      </p>

      <h2>How can I find out what permits were pulled for my home?</h2>
      <p>
        Your local building department maintains permit records for your property. In most jurisdictions, you can request a permit history by address &mdash; either in person, by phone, or online. The permit history will show what work was permitted, when, by whom, and whether final inspections were completed. Any work that appears to have been done without a corresponding permit is potential exposure.
      </p>
      <p>
      ...
      <h2>What options do I have if I find unpermitted work before listing?</h2>
      <p>
      ...
      <h2>Why should I verify contractor license history even for past work?</h2>
      <p>
