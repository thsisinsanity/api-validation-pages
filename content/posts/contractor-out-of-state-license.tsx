export default function Post() {
  return (
    <>
      ...
      <h2>Does a contractor&apos;s license from one state allow them to work in another state?</h2>
      <p>
      ...
      <p>
        After major disasters, some states expedite temporary licensing for out-of-state contractors to address the volume of repair work. These expedited licenses are still real licenses &mdash; they just have a shorter validity period. An out-of-state contractor performing post-disaster work should be able to show you either a temporary license for your state or an established in-state license if they&apos;ve been operating in your region.
      </p>

      <h2>What should I verify when a contractor says they are licensed but in another state?</h2>
      <p>
        Ask for their home-state license number and verify it in that state&apos;s database to confirm they are legitimately licensed there. Then ask specifically how they are authorized to work in your state &mdash; are they applying their home-state license under a reciprocity agreement, do they hold a temporary work permit, or have they obtained a separate license in your state? Ask to see documentation of whichever authorization applies.
      </p>
      <p>
      ...
      <h2>Are there trades where out-of-state licensing is more complex?</h2>
      <p>
