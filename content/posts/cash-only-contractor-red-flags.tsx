export default function Post() {
  return (
    <>
      <p>
        When a contractor insists on cash payment only, they are telling you something important about how they operate. Cash-only requirements are not a preference or a convenience &mdash; they are a deliberate choice to eliminate the paper trail that protects you as a homeowner. Understanding exactly why cash-only requests are a red flag helps you recognize this pattern before you&apos;re in trouble.
      </p>
      <p>
      ...
      <h2>Why is cash-only payment a red flag for contractors?</h2>
      <p>
      ...
      <h2>What payment methods are safe for contractor work?</h2>
      <p>
      ...
      <h2>How much of a deposit is reasonable for a contractor?</h2>
      <p>
        Industry standard for a residential contractor deposit is 10&ndash;15% of the contract value. In some states &mdash; including California &mdash; the maximum legal deposit is capped at $1,000 or 10% of the contract price, whichever is less. A deposit request of 50% or more, especially in cash, is a significant red flag regardless of how convincing the contractor&apos;s explanation seems.
      </p>
      <p>
      ...
      <h2>How does cash-only behavior relate to contractor licensing?</h2>
      <p>
