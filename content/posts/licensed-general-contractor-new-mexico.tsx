export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in New Mexico: How to Verify Before You Hire</h1>

      <p>
        New Mexico requires all contractors to be licensed by the <strong>Construction Industries Division (CID)</strong> of the Regulation and Licensing Department at rld.nm.gov/cid. The CID licenses both general and specialty contractors, and all licensees must carry a <strong>$10,000 surety bond</strong>. New Mexico&apos;s CID database is publicly searchable and provides the primary verification resource for New Mexico homeowners.
      </p>

      <h2>What Is New Mexico&apos;s CID Contractor License?</h2>

      <p>
        The New Mexico CID issues contractor licenses in over 50 trade classifications. General contractors typically hold a <strong>GB-98 General Building and Construction Contractor</strong> license, which is one of the broadest classifications. Specialty contractors hold classification-specific licenses for electrical (EE-98), plumbing (PJ-1), HVAC (MM-98), and many other trades. For residential construction, a GB-98 or appropriate residential classification is the relevant credential.
      </p>
      ...
      <h2>What Does New Mexico&apos;s $10,000 Bond Cover?</h2>

      <p>
        New Mexico requires CID licensees to carry a <strong>$10,000 surety bond</strong>. The bond is filed with the CID as a condition of licensure. Bond claims can be pursued through the CID&apos;s complaint process. For larger New Mexico construction projects, the $10,000 bond provides only baseline protection &mdash; a project-specific performance bond is advisable for projects exceeding $50,000.
      </p>
      ...
      <h2>What Makes New Mexico&apos;s Licensing System Unique?</h2>
      ...
      <p>
        New Mexico&apos;s construction market includes significant commercial activity around Albuquerque, Santa Fe, and Las Cruces, as well as substantial rural and tribal construction projects. The state&apos;s geographic diversity &mdash; from high-altitude desert to mountain terrain &mdash; means construction conditions vary significantly, and licensed contractors are expected to understand the climate-specific code requirements for their work area.
      </p>

      <h2>How Do You Verify a New Mexico Contractor&apos;s License?</h2>
