export default function Post() {
  return (
    <>
      ...
      <h2>Does Pennsylvania require HVAC contractors to be licensed?</h2>
      <p>
      ...
      <p>
        This is an important distinction. An HVAC contractor in rural Pennsylvania may have no local licensing requirement whatsoever &mdash; making HICPA registration and insurance verification the primary consumer protection tools available to you. Always verify both.
      </p>

      <h2>What is HICPA and does it apply to HVAC contractors?</h2>
      <p>
        HICPA (Home Improvement Consumer Protection Act) is a Pennsylvania law requiring all home improvement contractors &mdash; including HVAC contractors &mdash; to register with the PA Attorney General&apos;s Office for any residential work with a contract value of $500 or more. Registration requires a $50,000 surety bond, general liability insurance, and annual renewal. You can verify HICPA registration through the Attorney General&apos;s online contractor database.
      </p>
      <p>
        Any HVAC contractor performing residential work in Pennsylvania &mdash; installing a new furnace, replacing a central air system, adding ductwork, or servicing existing equipment &mdash; is subject to HICPA if the contract exceeds $500. That threshold is met by virtually any HVAC job beyond a minor service call.
      </p>
      <p>
        HICPA registration provides:
      </p>
      <ul>
        <li><strong>A searchable record:</strong> The AG maintains a database you can search by name, registration number, or zip code</li>
        <li><strong>$50,000 surety bond protection:</strong> Financial recourse if the contractor takes your deposit and abandons the job</li>
        <li><strong>Insurance requirement:</strong> Contractors must carry general liability coverage to maintain registration</li>
        <li><strong>Written contract requirements:</strong> HICPA mandates written contracts with specific required terms for any work over $500</li>
      </ul>

      <h2>How do you verify an HVAC contractor&apos;s HICPA registration in Pennsylvania?</h2>
      <p>
        Go to the PA Attorney General&apos;s home improvement contractor lookup (available through the AG&apos;s official website) and search by the contractor&apos;s company name or HICPA registration number. Confirm the status shows Active, note the registration expiration date, and verify the $50,000 bond is listed. Ask the contractor for their HICPA number before any work begins &mdash; legitimate contractors have it readily available.
      </p>
      <p>
        When verifying HICPA registration, look for:
      </p>
      <ul>
        <li>Status: <strong>Active</strong> (not Expired, Revoked, or Suspended)</li>
        <li>Business name and address that matches what the contractor provided</li>
        <li>$50,000 surety bond listed and current</li>
        <li>Registration expiration date in the future</li>
      </ul>
      <p>
      ...
      <h2>What local HVAC licensing exists in Philadelphia and Pittsburgh?</h2>
      <p>
      ...
      <h2>What are the risks of hiring an unregistered HVAC contractor in Pennsylvania?</h2>
      <p>
      ...
      <p>
        Equipment manufacturers require licensed installation as a condition of their warranty. A new furnace or air conditioner purchased and installed without permits or by an uncertified installer typically voids the manufacturer&apos;s warranty immediately. On a $5,000&ndash;$15,000 HVAC system, that warranty loss is significant.
      </p>
      <p>
      ...
      <h2>What should you ask an HVAC contractor before hiring in Pennsylvania?</h2>
      <p>
      ...
      <ul>
        <li>HICPA registration number (verify at PA AG&apos;s website)</li>
        <li>EPA Section 608 certification (ask for the card)</li>
        <li>Certificate of liability insurance (minimum $1 million; call insurer to confirm)</li>
        <li>Workers&apos; compensation coverage (verify through PA Bureau of Workers&apos; Compensation)</li>
        <li>City-specific license if in Philadelphia or Pittsburgh</li>
        <li>Confirmation that all permits will be pulled for the installation</li>
      </ul>
