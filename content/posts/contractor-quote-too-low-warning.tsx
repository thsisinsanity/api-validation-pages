export default function Post() {
  return (
    <>
      <p>
        A bid that is significantly lower than every other bid you received feels like good luck. It is almost never good luck. When a contractor prices a project 30% or more below their competitors, something in that bid is missing &mdash; and finding out what it is before signing is the entire point of getting multiple bids.
      </p>
      <p>
      ...
      <h2>Why are suspiciously low contractor bids dangerous?</h2>
      <p>
        A suspiciously low bid is dangerous because it nearly always reflects something missing from the scope, materials, or labor estimate &mdash; and you&apos;ll discover what&apos;s missing partway through the project when stopping is more expensive than continuing. The contractor may be planning to use inferior materials, skip permit-required work, hire unlicensed day laborers, or simply bill for &ldquo;unforeseen conditions&rdquo; until the project reaches normal market price.
      </p>
      <p>
      ...
      <h2>What are the most common ways a low bid is not what it appears?</h2>
      <p>
      ...
      <h2>How do I identify what a low bid is missing?</h2>
      <p>
      ...
      <p>
        Then, for the low bid specifically, ask the contractor to explain directly why their price is lower than competitors. A legitimate contractor with lower costs can answer this question clearly &mdash; they may have lower overhead, bulk material purchasing relationships, or a more efficient crew. A contractor who responds with vague assurances without specific explanation is not giving you information you can evaluate.
      </p>

      <h2>Does a low bid correlate with unlicensed status?</h2>
      <p>
