export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Michigan: How to Verify Before You Hire</h1>

      <p>
        Michigan requires residential contractors to hold a <strong>Residential Builder license</strong> issued by the Department of Licensing and Regulatory Affairs (LARA) at michigan.gov/lara. LARA licenses residential builders, maintenance and alteration contractors, and several specialty trades. For anyone building or significantly renovating a Michigan home, verifying the contractor&apos;s LARA license is a critical first step.
      </p>

      <h2>What Is Michigan&apos;s Residential Builder License?</h2>
      ...
      <h2>What Insurance Does a Michigan Residential Builder Need?</h2>
      ...
      <p>
        Ask for a current certificate of insurance before any Michigan contractor begins work. Verify the certificate is current by calling the insurance company listed. Contractor insurance certificates can be forged &mdash; a direct call to the insurer is the only reliable verification. Also ask whether the contractor carries builder&apos;s risk insurance for projects under construction, which covers damage to incomplete work.
      </p>

      <h2>How Do You Verify a Michigan Contractor&apos;s License?</h2>

      <p>
        LARA maintains an online license search tool at michigan.gov/lara. Search by business name, individual name, or license number. The results show the license type (Residential Builder or M&amp;A), status, and expiration date. Confirm the status shows &ldquo;active&rdquo; and that the license type matches the scope of your project.
      </p>
