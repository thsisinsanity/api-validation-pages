export default function Post() {
  return (
    <>
      <h1>Licensed Solar Contractor in California: How to Verify Before You Hire</h1>

      <p>
        <strong>California solar contractors must hold both a C-46 (Solar) classification and typically a C-10 (Electrical) classification from the California Contractors State License Board (CSLB).</strong> Solar installation is one of the highest-fraud home improvement categories in the state, and the CSLB has conducted dedicated solar contractor sting operations to address the problem. Verifying both C-46 and C-10 credentials at cslb.ca.gov before signing any solar contract is essential.
      </p>

      <h2>What Licenses Does a Solar Contractor Need in California?</h2>

      <p>
        California solar contractors need at minimum a C-46 Solar Contractor classification from the CSLB. The C-46 covers the installation of solar energy systems including photovoltaic (PV) panels, mounting systems, inverters, and associated wiring. However, the C-46 classification alone may not cover all electrical work associated with solar installation &mdash; particularly the connection to the main electrical panel, which requires a C-10 Electrical classification.
      </p>
      ...
      <h2>How Do You Verify a Solar Contractor&apos;s License in California?</h2>
      ...
      <h2>Why Is Solar One of the Highest-Fraud Home Improvement Categories?</h2>
      ...
      <ul>
        <li>
          <strong>Exaggerated energy savings:</strong> Contractors overstate how much electricity the system will produce, inflating the projected financial return to justify a higher contract price. When actual production falls short of projections, homeowners are left paying for a system that does not deliver the promised savings.
        </li>
        <li>
          <strong>Predatory financing:</strong> Solar lease agreements and power purchase agreements (PPAs) can include unfavorable terms that homeowners do not fully understand, including escalating payment rates, transfer restrictions on property sales, and balloon payments.
        </li>
        <li>
          <strong>Defective installation:</strong> Improperly installed solar panels can cause roof damage, electrical fires, and system underperformance. The fire risk from improperly installed solar wiring is a documented safety concern &mdash; the National Fire Protection Association has issued guidance on solar-related fire risks.
        </li>
        <li>
          <strong>Permit fraud:</strong> Some solar contractors install systems without pulling required electrical and building permits, meaning the installation is never inspected and code violations may never be caught until a fire or insurance claim forces an investigation.
        </li>
      </ul>

      <h2>What Questions Should You Ask a Solar Contractor in California?</h2>
      ...
      <ul>
        <li>Ask for the CSLB license number and confirm both C-46 and C-10 classifications</li>
        <li>Ask whether the contractor or a subcontractor will do the electrical panel work</li>
        <li>Ask for proof of liability insurance (minimum $1 million per occurrence)</li>
        <li>Ask for a written system production estimate in kWh per year, with the methodology explained</li>
        <li>Ask who will pull the permits &mdash; permits should always be pulled by the contractor</li>
        <li>Ask for references from similar installations in your area completed within the last two years</li>
        <li>Review all financing documents carefully before signing, including total cost over the loan or lease term</li>
      </ul>

      <h2>What Does Solar Installation Cost in California?</h2>
