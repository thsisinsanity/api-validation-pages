export default function Post() {
  return (
    <>
      <p>
        When you look up a contractor&apos;s license, you may find statuses other than &ldquo;active&rdquo; or &ldquo;expired.&rdquo; Terms like &ldquo;suspended,&rdquo; &ldquo;revoked,&rdquo; &ldquo;inactive,&rdquo; and &ldquo;probation&rdquo; have specific, important meanings &mdash; and understanding the difference tells you a great deal about the risk of hiring that contractor.
      </p>
      <p>
      ...
      <h2>What does a suspended contractor license mean?</h2>
      <p>
      ...
      <h2>What is the difference between an expired and an inactive license?</h2>
      <p>
      ...
      <p>
        An inactive license is one that the contractor has voluntarily placed in non-working status &mdash; often because they are not currently contracting, have moved states, or are transitioning between businesses. Inactive and expired licenses both represent non-current status, though an inactive license may be easier to reactivate.
      </p>

      <h2>What does a contractor license on probation mean?</h2>
      <p>
      ...
      <h2>How do I interpret unclear license status language in state databases?</h2>
      <p>
