export default function Post() {
  return (
    <>
      ...
      <h2>What electrician license types does Arkansas issue?</h2>
      <p>
      ...
      <h2>What insurance must Arkansas electricians carry?</h2>
      <p>
      ...
      <p>
        For homeowners, the consequences compound: no ASBEE bond claim, no board dispute process, failed inspections, voided insurance, and the full cost of corrections out of pocket. The $1,000 fine targets the contractor &mdash; only your own verification before hiring prevents the harm.
      </p>

      <h2>What else should I check before hiring an Arkansas electrician?</h2>
      <p>
        After confirming the ASBEE license at asbee.arkansas.gov, verify insurance with the carrier, confirm permits will be pulled for all electrical work, get a written scope and quote, and do not pay in full until the work passes inspection. Both the company and individual electrician licenses must be active &mdash; verify both.
      </p>
      <p>
