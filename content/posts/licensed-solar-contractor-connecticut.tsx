export default function Post() {
  return (
    <>
      ...
      <p>
        The HIC license covers the physical installation of solar panels &mdash; mounting, racking, roof penetrations, and structural components. The electrical work &mdash; everything from the panels to the utility meter and interconnection point &mdash; requires a separate E-1 Electrical Contractor license. A solar company that holds both can perform the complete installation. If they subcontract electrical work, the subcontractor must hold an E-1 license.
      </p>

      <h2>How do you verify a Connecticut solar contractor&apos;s licenses?</h2>
      <p>
      ...
      <h2>What is the Connecticut Green Bank and how does it affect hiring?</h2>
      <p>
      ...
      <h2>What bond is required for Connecticut solar contractors?</h2>
      <p>
      ...
      <h2>What are the risks of hiring an unlicensed solar contractor in Connecticut?</h2>
      <p>
