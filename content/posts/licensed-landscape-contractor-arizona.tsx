export default function Post() {
  return (
    <>
      ...
      <h2>Does Arizona require landscape contractors to be licensed?</h2>
      <p>
      ...
      <h2>What is the Arizona L-2 Landscape Contractor license?</h2>
      <p>
      ...
      <h2>Does Arizona require pesticide applicator licensing for landscape contractors?</h2>
      <p>
      ...
      <h2>What are the irrigation contractor requirements in Arizona?</h2>
      <p>
      ...
      <h2>What bond and insurance amounts should Arizona landscape contractors carry?</h2>
      <p>
      ...
      <h2>How do you verify a landscape contractor&apos;s license in Arizona?</h2>
      <p>
      ...
      <p>
        Arizona&apos;s AzROC is highly active in investigating complaints and revoking licenses for violations. The database includes complaint histories and disciplinary actions &mdash; review the full record, not just the active/inactive status. A contractor who has previously had their license suspended is a contractor to approach with extra caution.
      </p>

      <h2>What are the risks of hiring an unlicensed landscape contractor in Arizona?</h2>
      <p>
