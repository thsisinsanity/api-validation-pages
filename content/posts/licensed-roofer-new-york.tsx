export default function Post() {
  return (
    <>
      <p>
        New York doesn&apos;t have a single statewide roofing contractor license &mdash; but that doesn&apos;t mean anything goes. Roofing work in New York falls under the state&apos;s Home Improvement Contractor (HIC) registration system, with New York City maintaining its own separate registration. Understanding which registration applies, how to verify it, and what it covers is essential before you hire anyone to work on your roof.
      </p>

      <h2>Does New York require a license for roofing contractors?</h2>
      <p>
      ...
      <h2>How do you verify a roofing contractor&apos;s registration in New York?</h2>
      <p>
      ...
      <p>
        Unregistered home improvement contractors in New York cannot legally enter into contracts for home improvement work. A contract signed with an unregistered contractor may be unenforceable &mdash; which ironically makes it harder for you to recover money if things go wrong.
      </p>

      <h2>What bond and insurance does a New York roofing contractor need?</h2>
      <p>
        New York state HIC registration requires a $500 surety bond. This is a relatively low threshold &mdash; it covers administrative violations, not necessarily the full cost of defective work. Most reputable roofing contractors carry general liability insurance well above the state minimum.
      </p>
      <p>
      ...
      <h2>What are the risks of hiring an unregistered roofer in New York?</h2>
      <p>
        Hiring an unregistered home improvement contractor in New York is a consumer protection violation &mdash; and the risks fall primarily on you. New York&apos;s Home Improvement Business Law exists to protect homeowners from fraud, and working outside that law removes all the protections it provides.
      </p>
      <p>
      ...
      <h2>Does roofing work in New York require a permit?</h2>
      <p>
      ...
      <h2>What extra steps apply to New York City roofing contractors?</h2>
      <p>
      ...
      <p>
        The NYC contractor licensing landscape is more complex than upstate New York. If your property is in the five boroughs, verify all applicable registrations &mdash; state HIC, NYC HIC, and any DOB-required licenses &mdash; before signing a contract.
      </p>
