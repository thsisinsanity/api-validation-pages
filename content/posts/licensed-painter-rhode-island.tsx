export default function Post() {
  return (
    <>
      ...
      <h2>Does Rhode Island require painters to be licensed?</h2>
      <p>
      ...
      <h2>What does the Rhode Island CRLB registration require?</h2>
      <p>
      ...
      <h2>Does Rhode Island require lead paint certification for painters?</h2>
      <p>
      ...
      <h2>What are the risks of hiring an unregistered painter in Rhode Island?</h2>
      <p>
