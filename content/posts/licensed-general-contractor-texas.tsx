export default function Post() {
  return (
    <>
      ...
      <h2>What Should You Verify When Hiring a Texas General Contractor?</h2>

      <p>
        Without a state GC license to verify, you need to apply extra scrutiny to Texas contractors. Start by verifying that any licensed trade subcontractors (electricians, plumbers, HVAC) are properly licensed through TDLR at tdlr.texas.gov. Then confirm the contractor has pulled the required building permits with the local city &mdash; unpermitted work in Texas is common and creates the same insurance and resale problems it does everywhere else.
      </p>
      ...
      <h2>How Does the Permit Process Protect Texas Homeowners?</h2>
      ...
      <p>
        Local building departments in Texas cities like Austin and Dallas have become increasingly strict about permit compliance following high-profile cases of structural failures in unpermitted work. Austin&apos;s Development Services Department processes over 50,000 permits annually and has increased enforcement of unpermitted construction. Getting permits is not optional &mdash; it&apos;s the closest thing to consumer protection Texas GC law provides.
      </p>

      <h2>What Trade Licenses Should a Texas GC&apos;s Subcontractors Have?</h2>
      ...
      <p>
        If a Texas GC cannot provide these subcontractor license numbers, or tells you licensing &ldquo;isn&apos;t required,&rdquo; treat that as a serious red flag. Licensed trade subcontractors are required for their specific work regardless of whether the GC holds a state license. An unlicensed electrician doing wiring in your Texas home is illegal regardless of who hired them.
      </p>
