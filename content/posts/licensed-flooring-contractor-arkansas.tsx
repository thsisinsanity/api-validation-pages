export default function Post() {
  return (
    <>
      <p>
        Arkansas homeowners hiring a flooring contractor need to understand the state&apos;s licensing rules before writing any check. The Arkansas Contractors Licensing Board (ACLB) requires contractors to hold a valid license for projects that exceed specific dollar thresholds &mdash; and flooring installation is covered under those rules. Knowing whether your contractor is properly licensed, bonded, and insured is the single most important step you can take before a flooring project starts.
      </p>

      <h2>Does Arkansas require flooring contractors to be licensed?</h2>
      <p>
      ...
      <p>
        The Arkansas Contractors Licensing Board regulates both general contractors and specialty subcontractors. Flooring installation is treated as a specialty trade, and contractors performing standalone flooring work &mdash; hardwood, tile, luxury vinyl plank, carpet, or similar materials &mdash; typically operate under a subcontractor classification. If a general contractor is managing your project, they must be licensed regardless of the dollar amount if the project type requires it. Always ask whether the flooring installer is the licensed party or a subcontractor working under someone else&apos;s license.
      </p>

      <h2>Which agency licenses flooring contractors in Arkansas?</h2>
      <p>
      ...
      <h2>Are Arkansas flooring contractors required to carry bond and insurance?</h2>
      <p>
        Yes. The ACLB requires licensed contractors to maintain general liability insurance as a condition of licensure. Workers&apos; compensation coverage is also required for contractors with employees under Arkansas law. These protections directly benefit homeowners &mdash; if a flooring installer damages your subfloor, cabinets, or adjacent rooms during installation, their liability insurance covers the repair cost.
      </p>
      <p>
