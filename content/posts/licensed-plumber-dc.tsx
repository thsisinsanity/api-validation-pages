export default function Post() {
  return (
    <>
      ...
      <h2>How Do You Verify a Plumber&apos;s License in Washington DC?</h2>

      <p>
        Use the DCRA&apos;s online licensing portal at dcra.dc.gov to search for a plumber by name or license number. Confirm the license type is &ldquo;Master Plumber&rdquo; or &ldquo;Journeyman Plumber&rdquo; as appropriate, the status shows &ldquo;active,&rdquo; and the expiration date is current. Also verify the HIC license and bond status for the plumbing contractor entity.
      </p>
