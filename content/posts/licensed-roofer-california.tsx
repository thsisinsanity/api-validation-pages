export default function Post() {
  return (
    <>
      <p>
        California has some of the strictest contractor licensing laws in the country. If you&apos;re hiring someone to work on your roof, state law requires them to hold a valid license &mdash; and verifying that license before signing any contract could save you thousands of dollars and serious legal headaches.
      </p>

      <h2>Does California require roofers to be licensed?</h2>
      <p>
        Yes. As of June 6, 2026, any roofing contractor performing work valued at $1,000 or more in California must hold a valid license issued by the Contractors State License Board (CSLB). Assembly Bill 2622 raised this threshold from the previous $500 limit, but the exemption only applies if no building permit is required and the unlicensed person works alone &mdash; conditions that virtually never apply to roofing. In practice, nearly all roofing work still requires a licensed contractor. Hiring an unlicensed roofer exposes you to significant financial and legal risk.
      </p>
      <p>
      ...
      <h2>What is a Class C-39 roofing license?</h2>
      <p>
      ...
      <h2>How do you verify a roofer&apos;s license in California?</h2>
      <p>
      ...
      <h2>What bond and insurance does a California roofer need?</h2>
      <p>
      ...
      <p>
        In addition to the required bond, reputable roofers should carry general liability insurance and workers&apos; compensation insurance if they have employees. Under SB 291, starting January 1, 2026, a valid workers&apos; comp certificate becomes mandatory for CSLB license renewal or reinstatement &mdash; with minimum fines of $10,000 for sole owners and $20,000 for others who fail to comply. Liability insurance covers damage to your property caused by the contractor&apos;s work. Workers&apos; comp protects you from being held liable if a worker is injured on your property.
      </p>
      <p>
        Always ask for a certificate of insurance and call the insurer directly to confirm the policy is active. Bonds and insurance are two separate protections &mdash; both matter.
      </p>

      <h2>What happens if you hire an unlicensed roofer in California?</h2>
      <p>
      ...
      <p>
        For the contractor, performing unlicensed work above the threshold is a misdemeanor in California. Repeat violations can be charged as a felony. Starting July 1, 2026, SB 779 raises the minimum civil penalty for unlicensed work from $200 to $1,500 per violation. The CSLB&apos;s Statewide Investigative Fraud Team (SWIFT) actively targets unlicensed operators &mdash; in 2024 alone, SWIFT conducted 46 sweep operations across 17 counties, performing 454 site visits and filing over 229 legal actions against unlicensed contractors.
      </p>

      <h2>What should you check beyond the license number?</h2>
      <p>
        A valid license is the minimum bar &mdash; not the final word. Once you&apos;ve confirmed the license is active and classified as C-39, check whether the CSLB record shows any disciplinary actions, citations, or judgments. A contractor can technically be licensed while still having a history of consumer complaints or code violations.
      </p>
      <p>
