export default function Post() {
  return (
    <>
      ...
      <p>
        New Jersey also requires individual electricians &mdash; not just contracting businesses &mdash; to hold personal credentials. This dual-layer requirement (business license plus individual qualification) is one of the reasons New Jersey&apos;s electrical licensing is among the most rigorous in the region.
      </p>

      <h2>How do you look up an electrician&apos;s license in New Jersey?</h2>
      <p>
      ...
      <h2>What bond and insurance must a New Jersey electrician carry?</h2>
      <p>
        New Jersey electrical contractors must file a $1,000 surety bond with the Board of Examiners under NJ &sect;45:5A-19 as a condition of licensure. The bond runs for a 24-month term and must be renewed upon expiration. In addition, NJ electrical contractors are required to carry $500,000 in general liability insurance &mdash; significantly higher than the requirements for general home improvement contractors and reflecting the severity of damage that electrical failures can cause. Contractors must also carry workers&apos; compensation insurance for their employees.
      </p>
      <p>
      ...
      <h2>What are the penalties for unlicensed electrical work in New Jersey?</h2>
      <p>
      ...
      <h2>What should you verify before hiring a New Jersey electrician?</h2>
      <p>
