export default function Post() {
  return (
    <>
      ...
      <h2>What does Yelp actually verify about contractors listed on the platform?</h2>
      <p>
        Yelp verifies business identity for Yelp Business accounts but does not verify contractor licenses, insurance, or bond status. Business owners self-report their credentials, and Yelp displays them without independent verification. A contractor can list &ldquo;Licensed and Insured&rdquo; on their Yelp profile based entirely on their own representation, with no third-party confirmation.
      </p>
      <p>
      ...
      <h2>What are Yelp reviews good for when evaluating contractors?</h2>
      <p>
      ...
      <h2>Why don&apos;t reviews alone protect you from unlicensed contractors?</h2>
      <p>
        Unlicensed contractors are not necessarily bad at their jobs. Many do competent work that generates satisfied customers and positive reviews. The risks of hiring unlicensed are not primarily about work quality &mdash; they are about legal and financial protection: insurance coverage, permit validity, warranty enforceability, and recourse options when something goes wrong.
      </p>
      <p>
      ...
      <h2>What does a license check show that Yelp cannot?</h2>
      <p>
      ...
      <p>
        In California, the CSLB&apos;s database even shows whether a contractor has had their license revoked multiple times under different names &mdash; a practice known as &ldquo;license hopping&rdquo; that serial fraudsters use to stay in business despite disciplinary history. Yelp would show multiple clean-looking businesses; the CSLB database would show the same person behind all of them.
      </p>
