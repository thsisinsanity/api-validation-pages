export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Iowa: How to Verify Before You Hire</h1>

      <p>
        Iowa does <strong>not have a statewide general contractor license</strong>. Like Indiana, Missouri, and Kansas, Iowa does not operate a state-level licensing program for general building contractors. Contractor regulation in Iowa is handled at the local level through building permits and, in some jurisdictions, local contractor registration requirements.
      </p>

      <h2>How Are Contractors Regulated in Iowa?</h2>

      <p>
        Iowa has no statewide licensing board for general contractors, which means anyone can legally perform general contracting work without holding a state credential. Local building departments in Iowa cities &mdash; Des Moines, Cedar Rapids, Davenport, Sioux City, Iowa City &mdash; administer permit requirements for construction work. Some Iowa cities have local contractor registration programs as well.
      </p>
      ...
      <h2>What Should Iowa Homeowners Verify When Hiring a GC?</h2>
      ...
      <h2>What Iowa Trade Licenses Should You Verify?</h2>

      <p>
        For any Iowa project involving electrical work, verify the electrician&apos;s license through the Iowa Department of Public Health. For plumbing work, verify the plumber&apos;s state license. These specialty contractor licenses are meaningful credentials &mdash; they require exams and continuing education. A general contractor who can provide and stand behind their subcontractors&apos; state trade licenses is demonstrating a level of professional accountability that goes beyond what the law requires in Iowa.
      </p>
      ...
      <h2>What Permits Are Required for Iowa Construction?</h2>
