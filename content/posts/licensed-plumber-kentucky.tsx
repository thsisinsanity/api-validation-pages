export default function Post() {
  return (
    <>
      ...
      <h2>Does Kentucky require plumbers to be licensed?</h2>
      <p>
      ...
      <p>
        Verify any plumber you hire before work begins. The cost of fixing botched plumbing &mdash; water damage, mold, failed inspections &mdash; far exceeds the cost of a credential check.
      </p>

      <h2>Where do I verify a Kentucky plumber&apos;s license?</h2>
      <p>
      ...
      <p>
        Plumbing companies and individual plumbers carry separate licenses. The company contracting for the work must be licensed, and the individual performing the work must also hold a current license. Verify both. A licensed company employing an unlicensed journeyman &mdash; or an unlicensed company using a licensed plumber&apos;s name &mdash; are both compliance failures.
      </p>
      <p>
      ...
      <h2>What license types do Kentucky plumbers hold?</h2>
      <p>
      ...
      <h2>What bond and insurance must Kentucky plumbers carry?</h2>
      <p>
        Kentucky licensed plumbing contractors are required to carry a surety bond
        as a condition of licensure. Master plumber license application fees are
        $150 for testing and $250 for the license itself, payable to the Kentucky
        State Treasurer. Journeyman plumber fees are $50 for testing and $60 for
        the license. The bond provides a financial backstop: if the contractor
        walks off the job, performs defective work, or refuses to fix damage they
        caused, you can make a claim against the bond to recover losses.
      </p>
      <p>
        Kentucky requires workers&apos; compensation insurance for any employer
        with one or more employees &mdash; there is no minimum threshold. This
        applies to full-time, part-time, seasonal, and even family member
        employees. Penalties for operating without coverage are severe: $100
        to $1,000 per employee per day, plus potential business closure and
        criminal charges. General liability insurance is also essential &mdash;
        the EPA estimates household leaks waste nearly 1 trillion gallons of
        water annually, and a single failed pipe can cause tens of thousands
        of dollars in structural damage.
      </p>
      <p>
        Always request and verify insurance certificates before work begins. Call the carrier to confirm the policy is active &mdash; not just that a certificate was issued.
      </p>

      <h2>What are the penalties for unlicensed plumbing in Kentucky?</h2>
      <p>
      ...
      <p>
        Homeowner&apos;s insurance policies commonly include exclusions for damage caused by unlicensed work. If an unlicensed plumber installs a water heater that later fails and floods your basement, you may find that your insurer denies the claim. The licensing requirement is not bureaucratic formality &mdash; it is a meaningful consumer protection with real financial consequences if ignored.
      </p>

      <h2>What else should I check before hiring a Kentucky plumber?</h2>
      <p>
        Beyond the license at dhbc.ky.gov, confirm that the plumber will pull the required permits. Permit records create a documented history of work performed on your home &mdash; valuable when selling. Verify insurance certificates with the carrier, not just the contractor. Get a written quote and scope of work before any payment is made, and do not pay in full until the work passes inspection.
      </p>
      <p>
