export default function Post() {
  return (
    <>
      ...
      <h2>Where do I verify an Alabama electrician&apos;s license?</h2>
      <p>
      ...
      <p>
        Name searches can be unreliable if the contractor registered under a legal entity name that differs from their trade name. Use the license number if you have it &mdash; it eliminates ambiguity. If the contractor cannot provide a license number, that is a problem.
      </p>
      <p>
      ...
      <h2>What are the Alabama electrical contractor license classifications?</h2>
      <p>
      ...
      <h2>What bond requirements apply to Alabama electrical contractors?</h2>
      <p>
        Alabama requires Electrical Contractors licensed through the AECB to post a $10,000 surety bond. The bond provides financial recourse if the contractor fails to complete the work, walks off the job, or causes damage they refuse to fix. In addition to the bond, electrical contractors should carry general liability insurance and workers&apos; compensation. Alabama only requires workers&apos; comp for employers with five or more regular employees &mdash; meaning many small electrical contractors are not legally required to carry it, even though electrical work is one of the most dangerous trades. Request certificates for both before work begins and confirm them directly with the issuing carrier. Electrical contractor licenses must be renewed annually ($125 fee) and licensees must complete 14 hours of continuing education every two years.
      </p>
      <p>
        Electrical work poses direct safety risk &mdash; faulty wiring causes fires. General liability coverage protects your home if something goes wrong during the job. Workers&apos; compensation protects you from liability if an electrician is injured on your property. Neither is optional if you want real protection.
      </p>

      <h2>What are the risks of hiring an unlicensed electrician in Alabama?</h2>
      <p>
