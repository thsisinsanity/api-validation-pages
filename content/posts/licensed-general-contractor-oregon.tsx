export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Oregon: How to Verify Before You Hire</h1>

      <p>
        Oregon requires all contractors to be licensed through the <strong>Oregon Construction Contractors Board (CCB)</strong> at ccb.oregon.gov. The CCB licenses all residential and commercial contractors, requires a <strong>$15,000 surety bond</strong>, and maintains one of the most comprehensive contractor databases in the Pacific Northwest. Oregon&apos;s system also includes a recovery fund for homeowners harmed by licensed contractors.
      </p>

      <h2>What Is Oregon&apos;s CCB Contractor License?</h2>

      <p>
        The Oregon CCB issues contractor licenses in several categories. A <strong>Residential General Contractor</strong> license covers new construction and renovation of residential properties. A <strong>Residential Specialty Contractor</strong> license covers specific trades within residential projects. Commercial contractor licenses cover non-residential work. Most homeowners hiring for a remodel or new construction will be working with a Residential General Contractor licensee.
      </p>

      <p>
        Oregon&apos;s CCB licensing requires contractors to pass a written exam covering Oregon building codes and business practices. Licensees must also carry the required bond and liability insurance. The CCB issues an endorsement system within the license categories &mdash; different endorsements allow different scopes of work. Verify that the contractor&apos;s CCB license includes the endorsements relevant to your project.
      </p>
