export default function Post() {
  return (
    <>
      ...
      <p>
        The American Arbitration Association reports that construction disputes submitted to mediation are settled at rates between 70&ndash;80%, making it a highly effective alternative to the adversarial process.
      </p>

      <h2>What is contractor mediation and how does it work?</h2>
      <p>
        Mediation is a voluntary, confidential dispute resolution process in which a neutral third party (the mediator) facilitates negotiation between you and the contractor. The mediator does not decide who is right &mdash; they help both parties communicate effectively and find a mutually acceptable resolution. Unlike arbitration or litigation, mediation does not produce a binding decision unless both parties agree to a settlement.
      </p>
      <p>
      ...
      <h2>When is mediation the right choice for a contractor dispute?</h2>
      <p>
      ...
      <h2>How much does contractor mediation cost?</h2>
      <p>
        Mediation cost depends on the provider and dispute complexity. Community mediation centers (often operated by bar associations or local governments) offer low-cost mediation, sometimes for $50&ndash;$200 per session. Private mediators charge by the hour, typically $150&ndash;$400 per hour with a half-day minimum, split between the parties. The American Arbitration Association and JAMS (both national ADR providers) handle construction disputes and have established fee schedules.
      </p>
      <p>
        Compare this to litigation: attorney fees for a residential contractor dispute in civil court typically run $5,000&ndash;$20,000 or more depending on complexity. Even if mediation fails, you will have a clearer picture of the dispute before spending that money.
      </p>

      <h2>What should I bring to a mediation session?</h2>
      <p>
      ...
      <p>
        Know your bottom line before you walk in &mdash; the minimum resolution you will accept. Know your realistic ceiling as well &mdash; what you could conceivably get. Having clear parameters prevents you from making poor decisions under pressure during the session.
      </p>

      <h2>How do I find a mediator for a contractor dispute?</h2>
      <p>
