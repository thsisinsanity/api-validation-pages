export default function Post() {
  return (
    <>
      ...
      <h2>How do I find the right board to file a complaint with?</h2>
      <p>
        Identify the state contractor licensing board for the state where the work was performed. The National Association of State Contractors Licensing Agencies (NASCLA) maintains a directory of all state boards. In some states, different boards govern different trades &mdash; a general contractor board handles GC complaints, while a separate plumbing board handles plumbing complaints. Make sure you&apos;re filing with the board that issued the specific license.
      </p>
      <p>
      ...
      <h2>What documentation do I need before filing a complaint?</h2>
      <p>
      ...
      <h2>What happens after I file a complaint?</h2>
      <p>
      ...
      <p>
        The timeline varies by state and board workload. Simple complaints may resolve in 60&ndash;90 days; complex cases can take 6&ndash;12 months. You will typically be notified of the outcome.
      </p>

      <h2>Should I file a complaint even if the contractor is unlicensed?</h2>
      <p>
