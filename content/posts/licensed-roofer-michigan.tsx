export default function Post() {
  return (
    <>
      <p>
        Michigan&apos;s weather is hard on roofs &mdash; from heavy snowfall and ice dams in winter to severe thunderstorms and hail in spring and summer. When your roof needs repair or replacement, hiring the right contractor matters. In Michigan, roofing work falls under specific licensing requirements that every homeowner should understand before signing a contract.
      </p>

      <h2>Does Michigan require a license for roofing contractors?</h2>
      <p>
      ...
      <h2>Which agency licenses roofers in Michigan?</h2>
      <p>
      ...
      <p>
        LARA maintains an online license verification database where you can confirm whether a roofer holds an active, valid license. This database is public and free to use &mdash; there&apos;s no excuse for skipping this step before you hire.
      </p>

      <h2>How do you look up a roofing contractor license in Michigan?</h2>
      <p>
      ...
      <h2>What is the difference between a Residential Builder and a Maintenance &amp; Alteration Contractor?</h2>
      <p>
      ...
      <h2>What bond and insurance should a Michigan roofer carry?</h2>
      <p>
        Michigan requires Residential Builders to carry a $25,000 surety bond
        and minimum $500,000 in general liability insurance. Maintenance &amp;
        Alteration Contractors have separate bond requirements. In addition,
        roofing contractors must carry workers&apos; compensation insurance if
        they regularly employ one or more workers for 35 or more hours per
        week for at least 13 weeks, or if they employ three or more workers
        at any one time regardless of hours worked.
      </p>
      <p>
        Always ask for a current certificate of insurance before work begins. Roofing is one of the most hazardous trades &mdash; the Bureau of Labor Statistics consistently ranks roofing among the top industries for work-related fatalities. If a worker is injured on your property and the contractor lacks workers&apos; compensation coverage, you could face liability.
      </p>

      <h2>What are the risks of hiring an unlicensed roofer in Michigan?</h2>
      <p>
        Hiring an unlicensed roofer in Michigan creates serious financial and legal exposure. An estimated $17 billion is lost annually in the U.S. to contractor fraud, and roofing scams &mdash; especially after storms &mdash; are among the most common forms. Unlicensed contractors frequently take deposits and disappear, or complete work so poorly that it fails within months.
      </p>
      <p>
        Michigan law gives homeowners a limited set of options when dealing with unlicensed contractors. You cannot file a complaint with LARA against someone who was never licensed, and small claims court may be your only recourse &mdash; assuming you can find the contractor. Licensed contractors, by contrast, can be reported to LARA, which has real enforcement authority.
      </p>

      <h2>What questions should you ask a Michigan roofer before hiring?</h2>
      <p>
        Ask for the contractor&apos;s Michigan license number, then verify it yourself at michigan.gov/lara/bureau-list/bpl/lic. Ask for a certificate of general liability insurance and workers&apos; compensation coverage. Get the full company name, physical address, and phone number &mdash; storm chasers and fly-by-night operations often provide only a cell number and a PO box.
      </p>
      <p>
