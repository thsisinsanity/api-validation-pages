export default function Post() {
  return (
    <>
      ...
      <h2>Does Pennsylvania require roofers to be licensed?</h2>
      <p>
      ...
      <p>
        HICPA became law in 2009 after widespread roofing fraud in Pennsylvania following storm seasons. The law requires every home improvement contractor &mdash; roofing, siding, remodeling, and more &mdash; to register with the Office of Attorney General and carry a $50,000 surety bond. Registration is not a license in the traditional sense (no exam required), but an unregistered contractor is breaking the law.
      </p>

      <h2>What does HICPA registration require for Pennsylvania roofers?</h2>
      <p>
      ...
      <ul>
        <li><strong>$50,000 surety bond:</strong> Required for all home improvement contractors, including roofers. This bond provides financial recourse for homeowners if the contractor fails to complete work or violates the contract.</li>
        <li><strong>General liability insurance:</strong> Must be maintained throughout the registration period. The contractor must carry coverage adequate for the type and scale of work being performed.</li>
        <li><strong>Annual registration renewal:</strong> HICPA registration is not permanent. Verify that the registration is current, not just that it was issued at some point in the past.</li>
        <li><strong>Written contracts:</strong> HICPA requires written contracts for any residential home improvement work over $500. The contract must include the contractor&apos;s registration number, a description of work, total price, and start/completion dates.</li>
      </ul>

      <h2>How do you look up a roofer&apos;s HICPA registration in Pennsylvania?</h2>
      <p>
        Search the Pennsylvania Attorney General&apos;s home improvement contractor database at hicsearch.attorneygeneral.gov. You can search by contractor name, registration number, or zip code. HICPA registration numbers follow the format &quot;PA&quot; followed by a numeric sequence (e.g., PA123456). The results show the registration status, the bond information on file, and the contractor&apos;s business address. Confirm the registration is &quot;Active&quot; before signing any contract.
      </p>
      <p>
        The Pennsylvania Attorney General&apos;s Office maintains the searchable HICPA database. To verify a roofer:
      </p>
      <ul>
        <li>Visit the PA Attorney General&apos;s home improvement contractor lookup page</li>
        <li>Search by the company name or their HICPA registration number</li>
        <li>Confirm the registration status shows <strong>Active</strong></li>
        <li>Note the bond information and verify the $50,000 surety bond is listed</li>
        <li>Match the business name and address to what the contractor gave you</li>
      </ul>
      <p>
      ...
      <h2>What does the $50,000 bond actually protect you from?</h2>
      <p>
        The $50,000 HICPA surety bond provides a financial backstop if a registered contractor fails to complete the agreed work, abandons a project, or causes property damage and refuses to make it right. You can file a claim against the bond through the bonding company. The bond does not cover poor workmanship directly &mdash; it covers non-performance and contract breaches.
      </p>
      <p>
