export default function Post() {
  return (
    <>
      <p>
        Illinois is one of a handful of states with a dedicated statewide roofing contractor license. If you are hiring a roofer in Illinois, you can verify their license through the Illinois Department of Financial and Professional Regulation (IDFPR) &mdash; the same agency that licenses doctors, lawyers, and dozens of other professions in the state.
      </p>
      <p>
      ...
      <h2>Does Illinois require roofers to be licensed?</h2>
      <p>
      ...
      <h2>What does the Illinois IDFPR roofing contractor license require?</h2>
      <p>
      ...
      <ul>
        <li><strong>$10,000 surety bond:</strong> Required for all licensed roofing contractors in Illinois. This provides financial recourse for homeowners if the contractor fails to complete contracted work.</li>
        <li><strong>General liability insurance:</strong> Must be maintained throughout the license period. The minimum coverage requirement is set by IDFPR.</li>
        <li><strong>Biennial renewal:</strong> The license must be renewed every two years. An expired license means the contractor is no longer in compliance &mdash; even if they were licensed in the past.</li>
        <li><strong>Business entity in good standing:</strong> The contractor&apos;s business must be registered and active with the Illinois Secretary of State.</li>
      </ul>
      <p>
      ...
      <h2>How do you look up a roofing contractor&apos;s license in Illinois?</h2>
      <p>
      ...
      <ul>
        ...
        <li>Select <strong>Roofing Contractor</strong> from the license type options</li>
        <li>Search by the company name, individual name, or license number</li>
        <li>Confirm the license status is <strong>Active</strong> (not Expired, Inactive, or Revoked)</li>
        <li>Note the license expiration date to confirm renewal is current</li>
        <li>Verify the name on the license matches the business name you were given</li>
      </ul>
      <p>
      ...
      <h2>What do different IDFPR license statuses mean for roofing contractors?</h2>
      <p>
        An Active status means the license is current, the bond is on file, and the contractor is in good standing with IDFPR. An Expired status means the contractor previously held a license but has not renewed &mdash; they are not currently authorized to perform roofing work in Illinois. A Revoked or Suspended status means IDFPR took disciplinary action against the contractor, which is a serious red flag. Only hire roofers with an Active IDFPR license.
      </p>
      <p>
        Illinois roofing license statuses to know:
      </p>
      <ul>
        <li><strong>Active:</strong> License is current. The contractor is legally authorized to perform roofing work in Illinois.</li>
        <li><strong>Expired:</strong> The license was not renewed. The contractor is not currently authorized to work &mdash; even if they used to be licensed. Do not hire.</li>
        <li><strong>Inactive:</strong> The license has been placed in inactive status by the holder or IDFPR. Not authorized to work.</li>
        <li><strong>Revoked:</strong> IDFPR took action to permanently end the license due to violations or fraud. Do not hire under any circumstances.</li>
        <li><strong>Suspended:</strong> The license has been temporarily suspended by IDFPR, typically due to complaints, bond lapse, or other violations.</li>
      </ul>

      <h2>What are the risks of hiring an unlicensed roofer in Illinois?</h2>
      <p>
      ...
      <p>
        Illinois takes unlicensed roofing contractor violations seriously. Under the Roofing Industry Licensing Act, unlicensed contracting in Illinois can result in civil penalties and stop-work orders. But those penalties are collected by the state &mdash; not by you. Once an unlicensed contractor has your money and has done poor work or disappeared, recovery is through civil court only, and finding an unlicensed operator is much harder than filing a complaint against a licensed one.
      </p>
      <p>
        The IDFPR also accepts complaints against licensed roofing contractors &mdash; meaning that if you hire a licensed roofer and they do substandard work or violate the contract, you have a regulatory body with enforcement authority to escalate to. That recourse disappears entirely with an unlicensed contractor.
      </p>

      <h2>What else should you verify when hiring an Illinois roofer?</h2>
      <p>
      ...
      <ul>
        <li><strong>Workers&apos; compensation:</strong> Required in Illinois for all employers with one or more employees &mdash; no threshold exception. Verify through the Illinois Workers&apos; Compensation Commission or ask for a certificate</li>
        <li><strong>General liability insurance:</strong> IDFPR requires at least $250,000 in property damage and $500,000 in general liability for a Limited License (higher for Unlimited). Request a certificate and call the insurer to confirm it is active</li>
        <li><strong>Building permits:</strong> Required for most roof replacements; confirm the contractor will pull the permit</li>
        <li><strong>Chicago registration:</strong> If the project is in Chicago, verify any additional city contractor registration requirements at chicago.gov/buildings</li>
        <li><strong>Manufacturer certifications:</strong> Optional but valuable &mdash; GAF Master Elite, Owens Corning Preferred, or similar indicate factory-trained installation</li>
      </ul>
