export default function Post() {
  return (
    <>
      <h1>How to Find a Licensed Roofer in Washington DC</h1>

      <p>
        In Washington DC, roofers who perform residential or commercial work must hold a <strong>Home Improvement Contractor (HIC) license</strong> issued by the DC Department of Consumer &amp; Regulatory Affairs (DCRA). Any roofing project &mdash; repair or replacement &mdash; on a DC property requires a properly licensed contractor and a valid building permit. Working with an unlicensed roofer puts you at legal and financial risk.
      </p>

      <h2>Who Licenses Roofers in Washington DC?</h2>
      ...
      <h2>What Bond Is Required for DC Roofing Contractors?</h2>

      <p>
        All licensed home improvement contractors in Washington DC, including roofers, must maintain a <strong>$25,000 surety bond</strong>. This bond is a financial guarantee that the contractor will complete work as agreed and comply with DC law. If a roofer abandons your project, performs defective work, or defrauds you, you can file a claim against the bond to recover your losses.
      </p>
      ...
      <p>
        When verifying a roofer&apos;s HIC license, check that the bond is current &mdash; not just that a license was issued at some point. Bond lapses are a common signal that a contractor is in financial trouble. The DCRA license lookup will show bond status alongside the license itself.
      </p>

      <h2>What Happens If You Hire an Unlicensed Roofer in DC?</h2>

      <p>
        Hiring an unlicensed roofer in Washington DC carries serious consequences for both the contractor and the homeowner. The DC Attorney General&apos;s office can pursue civil penalties of <strong>up to $2,000 per offense</strong> against unlicensed contractors. But the homeowner bears risks too: insurance claims for work performed without permits may be denied, and unpermitted work discovered during a home sale can derail the transaction entirely.
      </p>

      <p>
        If an unlicensed roofer is injured on your property, your homeowner&apos;s insurance may not cover the claim &mdash; and you could face personal liability. DC courts have held homeowners partially responsible for injuries when they knowingly hired unlicensed workers. Beyond liability, unlicensed roofing work is rarely inspected, meaning code violations can remain hidden until major water damage surfaces months or years later.
      </p>
      ...
      <h2>How Do You Verify a Roofer&apos;s License in Washington DC?</h2>

      <p>
        You can verify a roofer&apos;s HIC license directly on the DCRA website at permits.dc.gov. Search by the contractor&apos;s name or license number. Confirm the license status shows &ldquo;active,&rdquo; the expiration date is in the future, and the bond is on file. Cross-reference the business name on the license with the name on your contract &mdash; mismatches are a fraud signal.
      </p>
      ...
      <p>
        Before you sign any roofing contract in Washington DC, take two minutes to verify the license. A roof replacement is a $10,000&ndash;$30,000 investment in the District. The cost of verification is trivial compared to the risk of hiring someone operating without a license or with a lapsed bond.
      </p>
    </>
  );
}
