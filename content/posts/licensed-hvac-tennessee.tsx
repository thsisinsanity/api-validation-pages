export default function Post() {
  return (
    <>
      ...
      <h2>What licenses does a Tennessee HVAC contractor need?</h2>
      <p>
      ...
      <h2>How do you verify an HVAC contractor&apos;s license in Tennessee?</h2>
      <p>
      ...
      <h2>What bond and insurance should a Tennessee HVAC contractor carry?</h2>
      <p>
        Tennessee requires licensed contractors to post a $10,000 surety bond as a condition of licensing. The bond provides a limited financial backstop if a contractor fails to complete work or causes damage that goes unaddressed. For larger HVAC system replacements, the bond alone is insufficient protection &mdash; general liability insurance is equally important.
      </p>
      <p>
        Before any HVAC work begins, ask for a certificate of insurance confirming active general liability coverage and workers&apos; compensation insurance. Call the insurer to verify both are currently in force. HVAC installation involves electrical work, refrigerant handling, and rooftop or confined-space access &mdash; all environments where injuries can occur. Workers&apos; comp protects you from liability if a technician is hurt on your property.
      </p>

      <h2>What are the risks of hiring an unlicensed HVAC contractor in Tennessee?</h2>
      <p>
        The risks of unlicensed HVAC work go beyond an inefficient system. Improper combustion equipment installation &mdash; furnaces, heat pumps, or gas lines &mdash; can create carbon monoxide leaks. Carbon monoxide poisoning sends more than 50,000 Americans to emergency rooms every year, and malfunctioning heating equipment is a leading cause. Refrigerant mishandling can damage the environment and expose the homeowner to liability under federal law.
      </p>
      <p>
      ...
      <p>
        Unlicensed contractors typically carry no bond and no insurance. When something goes wrong &mdash; and with unlicensed HVAC work, it often does &mdash; your options for recovery are limited. Verification before hiring is your most effective protection.
      </p>
      ...
      <p>
        CheckLicensed.com makes Tennessee HVAC contractor verification fast and simple. For $25, you get an instant report on any contractor&apos;s license status, type, and expiration &mdash; so you can hire with full confidence. Visit CheckLicensed.com before your next HVAC project.
      </p>
    </>
  );
}
