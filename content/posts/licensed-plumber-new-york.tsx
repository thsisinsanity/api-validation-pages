export default function Post() {
  return (
    <>
      <p>
        Hiring a plumber in New York means navigating one of the most fragmented licensing systems in the country. There is no statewide plumber&apos;s license in New York. Plumbing is regulated locally, which means who licenses your plumber &mdash; and how to verify it &mdash; depends entirely on where you live.
      </p>
      <p>
      ...
      <h2>Does New York require plumbers to be licensed?</h2>
      <p>
        Yes, but licensing is handled locally rather than by New York State. New York City requires plumbers to hold a Master Plumber or Journeyman Plumber license issued by the NYC Department of Buildings. Outside NYC, licensing requirements vary by county and municipality &mdash; some counties require it, some do not.
      </p>
      <p>
      ...
      <h2>What types of plumber licenses exist in New York City?</h2>
      <p>
      ...
      <p>
        When you hire a plumbing company in NYC, the critical question is whether there is a Licensed Master Plumber associated with that company. A Master Plumber license requires significant field experience (typically at least seven years), passing a rigorous exam, and maintaining insurance. The business itself &mdash; not just the individual &mdash; must be licensed to do plumbing work in the five boroughs.
      </p>
      <p>
      ...
      <h2>How do you look up a plumber&apos;s license in New York City?</h2>
      <p>
      ...
      <ul>
        <li>Go to <strong>nyc.gov/buildings</strong> and navigate to the license lookup tool</li>
        <li>Select &quot;Plumber&quot; as the license type</li>
        <li>Search by the plumber&apos;s name or their license number</li>
        <li>Confirm the license is <strong>Active</strong> and not expired or suspended</li>
        <li>Verify the name on the license matches the company or individual you are hiring</li>
      </ul>
      <p>
      ...
      <h2>What is required of licensed plumbers in New York City beyond the license itself?</h2>
      <p>
        Licensed Master Plumbers in NYC must carry general liability insurance and workers&apos; compensation coverage for their employees. The DOB requires active insurance on file to maintain licensure. This means an active license number is itself an indicator of minimum insurance compliance &mdash; but you should still request a certificate of insurance directly before signing any contract.
      </p>
      <p>
      ...
      <ul>
        <li>That the plumber carries current general liability insurance (ask for a certificate)</li>
        <li>That workers&apos; compensation coverage is in place (verify through the NY Workers&apos; Compensation Board at wcb.ny.gov)</li>
        <li>That the contractor has a current business registration with the NY Department of State (searchable at apps.dos.ny.gov)</li>
        <li>That any required building permits are pulled through your local municipality</li>
      </ul>
      <p>
      ...
      <h2>What does it cost to hire an unlicensed plumber in New York?</h2>
      <p>
      ...
      <h2>What questions should you ask a New York plumber before hiring?</h2>
      <p>
      ...
      <ul>
        <li>What is your Master Plumber license number, and which borough or county issued it?</li>
        <li>Will you pull the permit for this job? (The answer must be yes for any significant work.)</li>
        <li>Can you provide a certificate of insurance showing current liability and workers&apos; comp coverage?</li>
        <li>Is the work covered under a written contract? (Required in New York for jobs over $500.)</li>
      </ul>
