export default function Post() {
  return (
    <>
      ...
      <h2>Does Connecticut require roofers to be licensed?</h2>
      <p>
      ...
      <h2>What bond and insurance must Connecticut roofers carry?</h2>
      <p>
        Connecticut requires HIC-registered contractors to carry a $15,000 surety bond. The bond is backed by the registration process, and claims against it are processed through the DCP. Connecticut also maintains a Home Improvement Guaranty Fund that can reimburse homeowners up to $25,000 per eligible claim when a registered contractor causes damage or fails to complete work &mdash; a protection not available in most other states. The fund is replenished through annual assessments on registered contractors.
      </p>
      <p>
      ...
      <h2>What are the penalties for unregistered roofing work in Connecticut?</h2>
      <p>
      ...
      <h2>What else should I check before hiring a Connecticut roofer?</h2>
      <p>
        After confirming the HIC registration at portal.ct.gov/dcp, verify that the written contract includes the registration number as required by Connecticut law. Confirm insurance with the carrier. Do not pay more than one-third upfront &mdash; Connecticut law limits advance payments for home improvement work. Hold the final payment until the job is complete and you are satisfied.
      </p>
      <p>
