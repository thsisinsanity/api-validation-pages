export default function Post() {
  return (
    <>
      ...
      <h2>Does Mississippi require plumbers to be licensed?</h2>
      <p>
      ...
      <p>
        Mississippi&apos;s plumbing licensing is administered separately from the general contractor licensing program through the MSBOC. Plumbing requires its own specific license &mdash; a general contractor license does not authorize plumbing work in Mississippi. Verify both the plumbing contractor license and the individual plumber&apos;s license before authorizing any work.
      </p>
      <p>
      ...
      <h2>Where do I verify a Mississippi plumber&apos;s license?</h2>
      <p>
        Verify a Mississippi plumber&apos;s license by contacting the Mississippi State Board of Plumbing Examiners. Also ask your local building department &mdash; local permit offices in Jackson, Gulfport, Biloxi, and other Mississippi cities can confirm whether a contractor is authorized to pull plumbing permits in your jurisdiction. Ask the contractor directly for their state plumbing license number and verify it with the board before authorizing work.
      </p>
      <p>
        Ask for both the plumbing contractor license (company) and the individual plumber&apos;s license number. A licensed Mississippi plumber will have both available without hesitation. Confirm permits will be pulled for your project &mdash; plumbing permit records protect your home&apos;s value and support insurance claims when water damage occurs.
      </p>

      <h2>What plumber license types exist in Mississippi?</h2>
      <p>
        Mississippi&apos;s plumbing board issues licenses at journeyman, master, and contractor levels. Journeyman plumbers are licensed to perform plumbing work under master supervision. Master plumbers have advanced qualifications and can supervise work, pull permits, and operate independently. Plumbing contractors are the business entities authorized to contract for plumbing projects &mdash; they must have a licensed master plumber as their qualifying individual.
      </p>
      <p>
      ...
      <h2>What insurance must Mississippi plumbers carry?</h2>
      <p>
        Mississippi requires a residential contractor license through the Mississippi
        State Board of Contractors (MSBOC) for plumbing-related remodeling work of
        $10,000 or more. New residential construction or commercial plumbing projects
        require an MSBOC license once the project reaches $50,000. Licensed plumbing
        contractors should carry general liability insurance and workers&apos;
        compensation for employees. Bond requirements vary by city &mdash; most
        Mississippi cities require a $5,000 contractor bond, though some like Tupelo
        require $10,000 for mechanical contractors. Verify credentials through the
        MSBOC&apos;s online search directory. Request certificates of insurance and
        call the carrier to confirm active coverage before any work begins.
      </p>
      <p>
        The Insurance Information Institute identifies water damage as one of the most common and costly homeowner insurance claims in the United States. Mississippi&apos;s humid climate means that plumbing failures can cause more rapid structural damage than in drier regions &mdash; mold can begin growing within 24-48 hours of water intrusion. Professional plumbing work reduces this risk; liability insurance provides recovery when problems still occur.
      </p>
      <p>
        Never accept a contractor&apos;s verbal assurance of insurance. Request the certificate and verify it with the carrier.
      </p>

      <h2>What are the penalties for unlicensed plumbing in Mississippi?</h2>
      <p>
