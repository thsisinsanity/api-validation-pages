export default function Post() {
  return (
    <>
      ...
      <h2>Where do I start looking for a licensed contractor?</h2>
      <p>
        The most reliable starting points are personal referrals from neighbors, friends, or family who recently completed similar projects. A referral gives you first-hand information about reliability, communication, and quality. Local building material suppliers &mdash; lumber yards, tile showrooms &mdash; often maintain informal lists of contractors they trust, because they see who pays bills on time and runs professional job sites.
      </p>
      <p>
      ...
      <h2>What databases can I use to check contractor licenses for free?</h2>
      <p>
      ...
      <p>
        These databases are free to use, but they have real limitations. Most use exact-match search, meaning a small typo in the business name returns no results. Many don&apos;t display license history or flag past complaints. And navigating 50 different database interfaces &mdash; each with its own search logic &mdash; is genuinely time-consuming if you&apos;re checking multiple contractors.
      </p>

      <h2>What is the difference between free state database checks and paid tools?</h2>
      <p>
      ...
      <p>
        A license number alone isn&apos;t enough. When you look up a contractor, confirm: (1) the license status is &ldquo;active&rdquo; or &ldquo;current&rdquo; &mdash; not expired, suspended, or revoked; (2) the name on the license matches the contractor or business you&apos;re dealing with; (3) the license classification covers the type of work being done; and (4) the expiration date has not passed. According to CSLB data, a significant percentage of license lookups reveal expired or inactive licenses that contractors continue to use.
      </p>
      <ul>
        <li>Ask for the license number in writing &mdash; don&apos;t rely on a verbal statement.</li>
        <li>Look up the number yourself, even if the contractor shows you a license card.</li>
        <li>Verify the contractor carries liability insurance and workers&apos; comp &mdash; ask for a certificate.</li>
        <li>Check whether any complaints or disciplinary actions appear in the licensing board record.</li>
      </ul>

      <h2>How many bids should I get before hiring?</h2>
      <p>
        For any project over $5,000, get at least three written bids from separately verified licensed contractors. Written bids should itemize labor and materials separately. A bid that is dramatically lower than the others &mdash; 30% or more &mdash; deserves scrutiny: ask specifically which line items account for the difference. Sometimes it reflects genuine efficiency; more often it reflects corners being cut, inferior materials, or a bait-and-switch strategy where the real cost escalates after work begins.
      </p>
      <p>
        The cheapest bid is rarely the best value. Focus on the combination of license status, insurance coverage, references, and a detailed written contract. Protecting yourself costs almost nothing &mdash; run a license check at <strong>CheckLicensed.com</strong> before signing with anyone.
      </p>
    </>
  );
}
