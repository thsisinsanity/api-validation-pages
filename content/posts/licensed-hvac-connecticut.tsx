export default function Post() {
  return (
    <>
      ...
      <h2>Does Connecticut require HVAC contractors to be licensed?</h2>
      <p>
      ...
      <p>
        Connecticut also enforces EPA Section 608 requirements for refrigerant handling at the federal level. Technicians working on air conditioning and refrigeration systems must hold EPA 608 certification appropriate to the type of refrigerant they handle. State licensing and federal certification serve different purposes &mdash; confirm both before allowing refrigerant work on your system.
      </p>
      <p>
      ...
      <h2>Where do I verify a Connecticut HVAC contractor&apos;s license?</h2>
      <p>
      ...
      <h2>What bond and insurance must Connecticut HVAC contractors carry?</h2>
      <p>
        Connecticut requires HIC-registered HVAC contractors to carry a $10,000 surety bond. The bond enables consumers to file claims when a contractor causes damage or fails to perform. Connecticut&apos;s Home Improvement Guarantee Fund provides additional financial recovery for homeowners harmed by registered contractor default &mdash; a unique consumer protection feature not available in most states.
      </p>
      <p>
      ...
      <h2>What are the penalties for unlicensed HVAC work in Connecticut?</h2>
      <p>
