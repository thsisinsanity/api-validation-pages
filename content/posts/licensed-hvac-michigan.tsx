export default function Post() {
  return (
    <>
      ...
      <h2>Which agency licenses HVAC contractors in Michigan?</h2>
      <p>
      ...
      <p>
        LARA also enforces the Michigan Mechanical Code, which governs how HVAC systems must be designed and installed. Permits issued under this code ensure that installations are inspected by a qualified official &mdash; another reason why working with a licensed contractor matters.
      </p>

      <h2>How do you look up an HVAC contractor&apos;s license in Michigan?</h2>
      <p>
      ...
      <h2>What do Michigan mechanical license classifications mean?</h2>
      <p>
      ...
      <h2>What bond and insurance should a Michigan HVAC contractor carry?</h2>
      <p>
        Michigan mechanical contractors operating as Residential Builders must carry
        a $25,000 surety bond and minimum $500,000 in general liability insurance.
        Workers&apos; compensation is mandatory if the contractor regularly employs one
        or more workers for 35+ hours per week for at least 13 weeks, or three or
        more workers at any time. These protections are in place because HVAC work
        involves gas lines, refrigerants, and electrical connections &mdash; all of
        which carry real risk if handled improperly, especially in Michigan&apos;s
        climate where furnace failures during sub-zero winters can be life-threatening.
      </p>
      <p>
      ...
      <h2>What are the risks of hiring an unlicensed HVAC contractor in Michigan?</h2>
      <p>
      ...
      <h2>How do you verify a Michigan HVAC contractor before hiring?</h2>
      <p>
        Look up the contractor&apos;s license at michigan.gov/lara/bureau-list/bpl/lic and confirm the status is active. Ask for proof of general liability insurance and workers&apos; compensation. Confirm they will pull a mechanical permit for the work &mdash; any legitimate HVAC contractor in Michigan will do this without hesitation.
      </p>
      <p>
