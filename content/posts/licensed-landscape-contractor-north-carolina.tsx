export default function Post() {
  return (
    <>
      ...
      <h2>Does North Carolina require landscape contractors to be licensed?</h2>
      <p>
      ...
      <h2>What does the North Carolina Landscape Contractor License require?</h2>
      <p>
      ...
      <h2>What are the irrigation contractor requirements in North Carolina?</h2>
      <p>
      ...
      <h2>What bond and insurance amounts should NC landscape contractors carry?</h2>
      <p>
      ...
      <h2>How do you verify a landscape contractor in North Carolina?</h2>
      <p>
      ...
      <h2>What are the risks of hiring an unlicensed landscape contractor in North Carolina?</h2>
      <p>
      ...
      <p>
        Before hiring any landscape contractor in North Carolina, verify credentials at <strong>CheckLicensed.com</strong>. For $25, get an instant report on LCLB license status, pesticide credentials, insurance, and complaint history &mdash; the fastest way to confirm you&apos;re hiring a properly licensed North Carolina landscape contractor.
      </p>
    </>
  );
}
