export default function Post() {
  return (
    <>
      ...
      <h2>What if the contractor doesn&apos;t have liability insurance?</h2>
      <p>
        If the contractor has no insurance &mdash; which is common with unlicensed contractors &mdash; your options narrow considerably. You can pursue the contractor directly in small claims or civil court. You can file a claim against their bond if they have one. Or you can file a claim against your own homeowner&apos;s insurance as a last resort, typically under your property coverage or in some cases your liability coverage if workers were injured.
      </p>
      <p>
      ...
      <h2>What documentation do I need if a contractor damages my home?</h2>
      <p>
        Document damage immediately with photos and video before any cleanup or mitigation. Get the contractor&apos;s license number, insurance certificate, and contact information in writing &mdash; if you don&apos;t already have it, ask for it now. Write a contemporaneous account of what happened, including dates, times, who was present, and what work was being performed when damage occurred.
      </p>
      <p>
        Notify the contractor in writing (email or text is fine) that damage occurred and that you expect them to address it through their insurance. Keep all this documentation in case you need to file a claim or pursue legal action. Never accept a verbal promise that the contractor will &ldquo;take care of it&rdquo; without written confirmation.
      </p>

      <h2>How do I prevent contractor damage before it happens?</h2>
      <p>
