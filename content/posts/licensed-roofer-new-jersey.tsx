export default function Post() {
  return (
    <>
      ...
      <h2>Which agency oversees roofing contractor registration in New Jersey?</h2>
      <p>
      ...
      <h2>How do you look up a roofer&apos;s registration in New Jersey?</h2>
      <p>
      ...
      <p>
        Confirm the registration is current &mdash; HIC registrations expire and must be renewed regularly. An expired registration means the contractor is not legally authorized to take on new residential roofing work in New Jersey. Always check before signing any contract or paying any deposit.
      </p>

      <h2>What bond and insurance must a New Jersey roofing contractor carry?</h2>
      <p>
