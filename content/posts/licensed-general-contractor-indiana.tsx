export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Indiana: How to Verify Before You Hire</h1>

      <p>
        Indiana does <strong>not have a statewide general contractor license</strong>. The Indiana Professional Licensing Agency (IPLA) at in.gov/pla licenses specific trades including electricians, plumbers, and HVAC contractors, but does not issue a general &ldquo;GC&rdquo; license. Contractor regulation in Indiana is primarily handled at the local municipality level through building permits and, in some jurisdictions, local contractor registration programs.
      </p>

      <h2>What Trades Are Licensed by Indiana at the State Level?</h2>
      ...
      <h2>What Should You Verify When Hiring an Indiana General Contractor?</h2>
      ...
      <h2>How Do Permits Protect Indiana Homeowners?</h2>

      <p>
        Indiana&apos;s building permit process is the primary consumer protection mechanism in a state without statewide GC licensing. Building inspectors review work at critical stages &mdash; framing, rough electrical, rough plumbing, HVAC rough-in, and final inspection &mdash; and must sign off before the project can close. According to the Indiana Department of Homeland Security, unpermitted construction work is among the most common sources of insurance claim denial and real estate transaction problems in the state.
      </p>

      <p>
        A contractor who offers to &ldquo;skip the permit&rdquo; in Indiana is shifting all quality control risk onto you. There is no inspection backstop, no code compliance verification, and no paper trail showing the work was done to standard. When you sell the property, any unpermitted work discovered by a buyer&apos;s inspector will need to be disclosed and may need to be remediated or permitted retroactively &mdash; often at significant cost.
      </p>

      <h2>What Insurance Should an Indiana GC Carry?</h2>
