export default function Post() {
  return (
    <>
      ...
      <h2>What is a certificate of occupancy and why does it matter?</h2>
      <p>
      ...
      <h2>When do I need a certificate of occupancy for a home renovation?</h2>
      <p>
        Not all renovations require a new CO &mdash; only those that involve new habitable space or a change in use. Adding a room, converting a basement or garage to living space, building an accessory dwelling unit, or constructing a new home all typically require a CO. Kitchen and bathroom remodels that don&apos;t change the footprint generally do not require a separate CO, though they do require permits and inspections.
      </p>
      <p>
        Your local building department is the definitive authority on what triggers a CO requirement in your jurisdiction. Call them early in the planning process &mdash; learning about CO requirements after the addition is built is not a position you want to be in.
      </p>

      <h2>How do I get a certificate of occupancy?</h2>
      <p>
      ...
      <h2>What happens if I don&apos;t have a certificate of occupancy for completed work?</h2>
      <p>
      ...
      <h2>How does a CO interact with homeowner&apos;s insurance and lending?</h2>
      <p>
