export default function Post() {
  return (
    <>
      ...
      <h2>Does Idaho require roofers to be licensed?</h2>
      <p>
      ...
      <h2>Where do I verify an Idaho roofer&apos;s license?</h2>
      <p>
      ...
      <p>
        Ask the contractor for their DBS license number before the appointment. Use it for a direct lookup. A licensed Idaho roofer will provide the number without hesitation. If the lookup returns no active license, ask for clarification &mdash; but do not authorize work to begin until you have confirmed an active license in the DBS database.
      </p>
      <p>
        Idaho sees post-storm contractor surges after hailstorms and severe weather events, particularly in the Treasure Valley and Magic Valley regions. Always verify that a contractor is licensed in Idaho &mdash; a license from another state does not authorize work here.
      </p>

      <h2>What contractor classifications apply to Idaho roofers?</h2>
      <p>
      ...
      <p>
        Idaho&apos;s contractor licenses also specify the scope of work the holder is authorized to perform. Verify that the classification matches the roofing scope of your project &mdash; a residential specialty roofing license does not authorize commercial flat roof installation.
      </p>

      <h2>What bond and insurance must Idaho roofers carry?</h2>
      <p>
        Idaho requires licensed contractors to carry a surety bond ranging from
        $2,000 to $30,000 depending on license classification. The bond provides
        a financial protection mechanism: if a licensed contractor causes damage,
        abandons the project, or refuses to remedy defective work, you can make a
        claim against the bond through the DBS complaint process. The bond must
        be active for the license to remain valid. Ask your roofer for their specific
        bond amount &mdash; the classification level determines coverage.
      </p>
      <p>
      ...
      <h2>What are the penalties for unlicensed roofing in Idaho?</h2>
      <p>
