export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Georgia: How to Verify Before You Hire</h1>

      <p>
        Georgia requires general contractors to be licensed through the <strong>Georgia Secretary of State&apos;s office</strong>. License verification is available at verify.sos.ga.gov. The licensing threshold is <strong>$2,500</strong> &mdash; any project with a total cost exceeding $2,500 requires a licensed contractor. Georgia&apos;s low threshold makes licensing relevant for nearly every residential project beyond minor repairs.
      </p>

      <h2>Who Issues General Contractor Licenses in Georgia?</h2>
      ...
      <p>
        Georgia also requires workers&apos; compensation for employers with three or more employees, which is a higher threshold than most states. This means a small GC with two employees is not required to carry workers&apos; comp under Georgia law &mdash; creating potential exposure for homeowners. Ask any Georgia contractor whether they carry workers&apos; comp regardless of whether it is legally required, and require it as a contract condition for any significant project.
      </p>

      <h2>How Do You Verify a Georgia Contractor&apos;s License?</h2>

      <p>
        Go to verify.sos.ga.gov and search by contractor name or license number. The results will show the license type, current status, and expiration date. Confirm the license is &ldquo;Active&rdquo; and that the name on the license matches the name on your contract. Also look for any disciplinary actions in the record.
      </p>
