export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Pennsylvania: How to Verify Before You Hire</h1>

      <p>
        Pennsylvania requires home improvement contractors to register under the <strong>Home Improvement Consumer Protection Act (HICPA)</strong>, administered by the Pennsylvania Attorney General&apos;s office. Registration is mandatory for any contractor performing home improvement work on residential properties, and contractors must carry a <strong>$50,000 bond</strong> &mdash; one of the highest bond requirements in the country.
      </p>

      <h2>What Is Pennsylvania&apos;s HICPA Registration?</h2>

      <p>
        HICPA, enacted in 2008, requires contractors who perform home improvement work on a residential property in Pennsylvania to register with the Attorney General&apos;s Bureau of Consumer Protection. Registration is not a skills-based license &mdash; there is no trade exam &mdash; but it requires proof of insurance, payment of a registration fee, and posting of a $50,000 bond. The registration creates legal accountability: contractors who violate HICPA face civil penalties and can lose their registration.
      </p>

      <p>
        HICPA applies broadly to any contractor who performs, offers to perform, or agrees to perform home improvement work for compensation. &ldquo;Home improvement&rdquo; includes virtually all residential repair, replacement, remodeling, and construction work. Tree trimming, driveway sealing, and pool installation are explicitly included. The law covers not just general contractors but specialty trades like roofers, plumbers, and HVAC contractors performing residential work.
      </p>
      ...
      <h2>How Do You Verify a Pennsylvania Contractor&apos;s Registration?</h2>

      <p>
        The Pennsylvania Attorney General&apos;s office maintains a searchable database of registered home improvement contractors at attorneygeneral.gov. Search by contractor name, business name, or registration number. The results show registration status, registration number, and business address. The database is updated regularly, so a result showing &ldquo;registered&rdquo; reflects current standing.
      </p>
