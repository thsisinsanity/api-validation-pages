export default function Post() {
  return (
    <>
      <p>
        Ohio does not have a statewide landscape contractor license. However, Ohio requires commercial pesticide applicators &mdash; including landscape contractors who treat lawns and ornamentals &mdash; to be licensed through the Ohio Department of Agriculture (ODA). Local jurisdictions in Ohio also have contractor licensing requirements that apply to landscape work. Understanding which credentials to check is essential before hiring any Ohio landscape contractor.
      </p>
      <p>
      ...
      <h2>Does Ohio require landscape contractors to be licensed?</h2>
      <p>
      ...
      <h2>What is the Ohio pesticide applicator licensing requirement?</h2>
      <p>
      ...
      <h2>What are the irrigation contractor requirements in Ohio?</h2>
      <p>
      ...
      <h2>What bond and insurance amounts should Ohio landscape contractors carry?</h2>
      <p>
        Ohio does not have a statewide bond requirement for landscape contractors. Workers&apos; compensation is required for Ohio employers with any employees and is administered through the Ohio Bureau of Workers&apos; Compensation (BWC). Ohio&apos;s BWC system is a state-administered monopoly &mdash; a legitimate Ohio landscape contractor with employees will have a BWC account number.
      </p>
      <p>
        Reputable Ohio landscape companies carry general liability insurance of $500,000 to $1 million per occurrence. Request a certificate of insurance before work begins. Confirm general liability coverage is active and ask for the BWC account number to verify workers&apos; compensation compliance. Ohio&apos;s BWC system makes workers&apos; comp verification straightforward &mdash; you can check BWC compliance at bwc.ohio.gov.
      </p>

      <h2>How do you verify a landscape contractor in Ohio?</h2>
      <p>
      ...
      <h2>What are the risks of hiring an unverified landscape contractor in Ohio?</h2>
      <p>
