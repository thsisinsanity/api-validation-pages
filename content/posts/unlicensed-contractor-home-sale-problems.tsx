export default function Post() {
  return (
    <>
      ...
      <h2>What specific problems does unlicensed contractor work create when selling a home?</h2>
      <p>
      ...
      <h2>How does unlicensed work affect a home appraisal?</h2>
      <p>
        Appraisers are required to flag unpermitted square footage. If a finished basement or garage conversion was done without permits, the appraiser may exclude that square footage from the livable area calculation &mdash; which directly reduces appraised value. If the home is being purchased with a mortgage, the appraised value caps what the lender will finance, which can leave a gap between the purchase price and the available financing.
      </p>
      <p>
        In addition, appraisers note items that are &ldquo;subject to&rdquo; permit verification. This creates contingencies in the appraisal that must be resolved before the loan can close. Even a minor unpermitted improvement can trigger this process.
      </p>

      <h2>What steps should I take before listing if I suspect prior unlicensed work?</h2>
      <p>
