export default function Post() {
  return (
    <>
      <p>
        New York does not have a statewide HVAC license. If you are hiring someone to install, repair, or replace your heating or cooling system in New York, the licensing requirements depend entirely on where you live &mdash; and in some parts of the state, the trade is barely regulated at all.
      </p>
      <p>
      ...
      <h2>What HVAC licenses does New York City require?</h2>
      <p>
      ...
      <ul>
        <li><strong>Oil Burner Installer:</strong> Required for anyone installing or servicing oil-fired heating equipment in NYC. This is a specific DOB license with its own exam and experience requirements.</li>
        <li><strong>High-Pressure Boiler Operating Engineer:</strong> Required for operating high-pressure boilers, common in larger residential and commercial buildings.</li>
        <li><strong>Special Rigger:</strong> May be required for certain mechanical installations involving hoisting or rigging of HVAC equipment.</li>
        <li><strong>General Contractor (Type 1 or 2):</strong> For larger HVAC system overhauls that involve structural or mechanical alterations, a licensed GC may be the responsible party.</li>
      </ul>
      <p>
        For residential HVAC work that does not involve oil burners or boilers &mdash; such as central air installation or mini-split systems &mdash; the contractor should at minimum hold an EPA Section 608 certification for refrigerant handling, and the job should be permitted through the NYC DOB.
      </p>

      <h2>How do you look up an HVAC contractor&apos;s license in New York City?</h2>
      <p>
      ...
      <h2>What should you verify for HVAC work outside New York City?</h2>
      <p>
      ...
      <ul>
        <li><strong>Insurance certificate:</strong> Minimum $1 million general liability for any significant HVAC installation. Call the insurer listed to confirm the policy is current.</li>
        <li><strong>Workers&apos; comp coverage:</strong> Verify through the NY Workers&apos; Compensation Board at wcb.ny.gov. If the crew injures themselves on your property and the contractor lacks workers&apos; comp, you may be liable.</li>
        <li><strong>EPA 608 certification:</strong> Ask for the technician&apos;s certification card. This is non-negotiable for any system involving refrigerant.</li>
        <li><strong>Permits:</strong> HVAC installations in most New York municipalities require a mechanical permit. A contractor who skips the permit is cutting corners at your expense.</li>
        <li><strong>Business registration:</strong> Verify the company is registered with the NY Department of State at apps.dos.ny.gov.</li>
      </ul>

      <h2>What does it cost to hire an unlicensed or uncertified HVAC contractor in New York?</h2>
      <p>
        The risks of hiring an unqualified HVAC contractor include improper refrigerant handling (an EPA violation), voided equipment warranties, failed inspections, and insurance claim denials if HVAC-related damage occurs. According to the EPA, illegal venting of refrigerants carries fines of up to $44,539 per day per violation &mdash; and a contractor who vents refrigerant illegally may expose you to liability as the property owner.
      </p>
      <p>
        Equipment manufacturers routinely void warranties if the system was installed without permits or by an uncertified technician. A $5,000 HVAC system that fails after two years due to improper installation is entirely your problem if permits were skipped &mdash; the manufacturer&apos;s warranty language specifically excludes improper installation.
      </p>
      <p>
      ...
      <h2>What should you ask an HVAC contractor in New York before hiring?</h2>
      <p>
      ...
      <ul>
        <li>Do you hold EPA Section 608 certification? What type (Universal, Type I, II, or III)?</li>
        <li>Are you licensed with the NYC Department of Buildings? (For NYC jobs.)</li>
        <li>Will you pull the permit for this installation?</li>
        <li>Can you provide a certificate of liability insurance and workers&apos; compensation?</li>
        <li>Is your business registered in New York State?</li>
      </ul>
