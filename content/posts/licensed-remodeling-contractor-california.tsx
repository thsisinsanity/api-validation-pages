export default function Post() {
  return (
    <>
      ...
      <p>
        The primary license classification for general home remodeling in California is the Class B &mdash; General Building Contractor. A Class B contractor is authorized to manage and perform construction projects that involve at least two unrelated building trades or crafts. Kitchen remodels, bathroom renovations, room additions, and whole-house renovations all typically fall within Class B scope.
      </p>

      <h2>What license classification do remodeling contractors need in California?</h2>
      <p>
      ...
      <h2>How do you verify a remodeling contractor&apos;s license in California?</h2>
      <p>
      ...
      <h2>What bond and insurance must a California remodeling contractor carry?</h2>
      <p>
      ...
      <h2>What happens if you hire an unlicensed remodeling contractor in California?</h2>
      <p>
      ...
      <p>
        Practically, unpermitted remodeling work &mdash; which unlicensed contractors frequently perform &mdash; can cause serious problems when you sell your home. Buyers&apos; inspectors typically flag unpermitted work, lenders may refuse to finance a home with unpermitted additions, and you may be required to tear out and redo work at your own expense to bring it into compliance.
      </p>

      <h2>What should you check beyond the license before hiring a remodeling contractor?</h2>
      <p>
