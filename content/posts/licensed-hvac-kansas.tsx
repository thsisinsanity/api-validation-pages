export default function Post() {
  return (
    <>
      ...
      <h2>What local HVAC requirements exist in Kansas?</h2>
      <p>
        Local Kansas jurisdictions require HVAC contractors to pull mechanical permits
        before performing installations. In Wichita and Sedgwick County, the
        Metropolitan Area Building and Construction Department (MABCD) issues
        mechanical licenses at apprentice, journeyman, and master levels.
        Journeyman licenses require passing an IAPMO exam ($125 fee) and cost $35,
        while contractor licenses cost $360. Master HVAC technicians must complete
        12 hours of continuing education every two years. Sedgwick and Johnson
        counties require $500,000 in general liability insurance and workers&apos;
        compensation certificates. Other cities including Kansas City (KS),
        Overland Park, and Topeka have their own building departments with separate
        requirements. Call your city or county building department to confirm
        the specifics for your jurisdiction.
      </p>
      <p>
        A contractor who is not registered with your local building department
        cannot pull a permit, which means either the work goes unpermitted (creating
        long-term risk for you) or they bring in a registered name just to pull the
        permit while doing the work themselves. Neither is a situation you want.
      </p>

      <h2>What federal requirements apply to Kansas HVAC contractors?</h2>
      <p>
      ...
      <p>
        Ask for EPA 608 certification cards for the specific technicians who will handle refrigerant. The Department of Energy reports that residential HVAC accounts for about 43% of home energy costs &mdash; a system installed by untrained technicians will waste energy and fail prematurely. EPA certification is a meaningful credential, not just a paperwork requirement.
      </p>

      <h2>What insurance must Kansas HVAC contractors carry?</h2>
      <p>
      ...
      <h2>What else should I check before hiring a Kansas HVAC contractor?</h2>
      <p>
