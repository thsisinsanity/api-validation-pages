export default function Post() {
  return (
    <>
      ...
      <h2>What is a punch list and when is it created?</h2>
      <p>
      ...
      <p>
        The punch list is created when the contractor believes the project is substantially complete and ready for final payment. &ldquo;Substantially complete&rdquo; means the work can be used for its intended purpose, even if minor items remain. The punch list captures those minor items so they don&apos;t get forgotten.
      </p>

      <h2>How do I create an effective punch list?</h2>
      <p>
        Walk through the entire project systematically with the contractor. Use a room-by-room approach and write down every item that doesn&apos;t meet the contract specifications or your quality expectations. Be specific and observable: describe each item in terms of location, type of defect, and what correction is needed. Avoid emotional or vague language &mdash; focus on measurable, correctable items.
      </p>
      <p>
        After the walkthrough, format the list clearly: numbered items, specific descriptions, and a completion deadline for each item. Email the final list to the contractor. Both parties should acknowledge the list in writing. A typical residential punch list might have 10&ndash;30 items; a complex remodel might have more.
      </p>

      <h2>What items typically appear on a residential punch list?</h2>
      <p>
      ...
      <h2>What are the contractor&apos;s obligations once a punch list is issued?</h2>
      <p>
        Once a punch list is issued and acknowledged, the contractor is obligated to complete all items within the timeframe specified in your contract (or within a reasonable time if not specified &mdash; typically 30 days for residential projects). Completing the punch list is a condition precedent to receiving final payment in most well-written contracts.
      </p>
      <p>
      ...
      <ul>
        <li>All punch list items should be completed before final payment is released.</li>
        <li>Give the contractor a specific completion deadline in writing.</li>
        <li>Inspect completed punch list items before signing off.</li>
        <li>Do not accept incomplete punch list resolution in exchange for reduced final payment &mdash; require full completion.</li>
      </ul>

      <h2>What if the contractor refuses to complete the punch list?</h2>
      <p>
