export default function Post() {
  return (
    <>
      ...
      <h2>Does Pennsylvania require plumbers to be licensed?</h2>
      <p>
      ...
      <h2>What is the difference between a Master Plumber and Journeyman Plumber in Pennsylvania?</h2>
      <p>
      ...
      <h2>How do you look up a plumber&apos;s license in Pennsylvania?</h2>
      <p>
      ...
      <ul>
        <li>Go to <strong>dos.pa.gov</strong> and click on &quot;Verify a License&quot;</li>
        <li>Select &quot;Plumber&quot; from the license type dropdown</li>
        <li>Enter the contractor&apos;s name or license number</li>
        <li>Confirm the license status is <strong>Active</strong></li>
        <li>Verify the license type is <strong>Master Plumber</strong> (or confirm a Master Plumber is associated with the business)</li>
        <li>Note the expiration date to confirm the license has not lapsed</li>
      </ul>
      <p>
      ...
      <h2>Does HICPA registration apply to plumbers in Pennsylvania?</h2>
      <p>
      ...
      <h2>What insurance should a licensed Pennsylvania plumber carry?</h2>
      <p>
      ...
      <p>
        The HICPA $50,000 bond is separate from the general liability insurance. The bond primarily protects against non-performance &mdash; a contractor who takes your deposit and walks away. General liability insurance covers property damage and injury during the work itself. You need both.
      </p>

      <h2>What are the consequences of hiring an unlicensed plumber in Pennsylvania?</h2>
      <p>
      ...
      <p>
        An unlicensed plumber also typically skips permits. Unpermitted plumbing is a problem when you sell your home &mdash; buyers&apos; inspectors flag unpermitted work, and you may have to remediate it before closing.
      </p>
