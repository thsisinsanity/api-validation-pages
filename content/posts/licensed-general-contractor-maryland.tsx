export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Maryland: How to Verify Before You Hire</h1>

      <p>
        Maryland requires home improvement contractors to be licensed by the <strong>Maryland Home Improvement Commission (MHIC)</strong>, part of the Department of Labor, Licensing and Regulation at dllr.state.md.us. MHIC licensees must carry a <strong>$20,000 surety bond</strong>. The MHIC license is required for virtually all residential renovation, repair, and construction work in Maryland.
      </p>

      <h2>What Does Maryland&apos;s MHIC License Cover?</h2>

      <p>
        The Maryland Home Improvement Commission licenses contractors who perform improvements to residential property. &ldquo;Home improvement&rdquo; under Maryland law includes virtually all repair, replacement, remodeling, alteration, conversion, modernization, improvement, or addition to residential property. The MHIC license is required for the contractor entity. Individuals who act as salespersons or project managers for MHIC-licensed contractors must also hold a separate MHIC salesperson license.
      </p>

      <p>
        Maryland&apos;s MHIC license is distinct from other state licenses in that it specifically covers residential work. Commercial construction in Maryland is regulated differently. For residential projects &mdash; which cover most homeowner-initiated work &mdash; the MHIC database at dllr.state.md.us is the primary verification source. The database is free and searchable by contractor name, license number, or trade name.
      </p>
      ...
      <h2>What Does Maryland&apos;s $20,000 Bond Protect?</h2>

      <p>
        Maryland&apos;s <strong>$20,000 MHIC bond</strong> provides financial protection for homeowners who suffer losses due to contractor fraud, abandonment, or breach of contract. The bond is filed with the MHIC and can be claimed through a formal complaint process. Maryland&apos;s MHIC also administers a <strong>Guaranty Fund</strong> that provides additional compensation up to $20,000 per claim for homeowners who cannot recover fully from the bond.
      </p>
      ...
      <h2>What Are Maryland&apos;s Home Improvement Contract Requirements?</h2>
      ...
      <h2>How Do You Verify a Maryland Contractor&apos;s MHIC License?</h2>

      <p>
        Search the MHIC database at dllr.state.md.us by contractor name, license number, or trade name. Confirm the license status is &ldquo;Active,&rdquo; the expiration date is future, and the bond is on file. Also verify the contractor has no pending complaints or disciplinary actions in the MHIC record.
      </p>
