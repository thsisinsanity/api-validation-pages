export default function Post() {
  return (
    <>
      ...
      <h2>Does Missouri require plumbers to be licensed?</h2>
      <p>
      ...
      <p>
        The absence of a state license does not mean plumbing work in Missouri is unregulated. Missouri municipalities have adopted plumbing codes &mdash; typically the International Plumbing Code (IPC) or a local equivalent &mdash; that govern how plumbing work must be performed. Permits, where required, mandate inspection by a local authority. The permit and inspection requirement is the most important check in a state with no licensing database.
      </p>
      <p>
      ...
      <h2>How does plumbing licensing work in St. Louis?</h2>
      <p>
      ...
      <p>
        St. Louis County is a separate jurisdiction from St. Louis City and has its own permit requirements through the St. Louis County Department of Public Works. A plumber licensed in St. Louis City is not automatically authorized to perform work in St. Louis County without meeting county-specific requirements. Determine which jurisdiction your address is in &mdash; city or county &mdash; before verifying credentials.
      </p>
      <p>
        Many St. Louis area addresses are in municipalities that are technically neither in St. Louis City nor St. Louis County &mdash; such as Clayton, Kirkwood, or Webster Groves. These cities often have their own permit and contractor requirements. Contact the local building department directly when in doubt.
      </p>

      <h2>How does plumbing licensing work in Kansas City?</h2>
      <p>
      ...
      <p>
        In the Kansas City metro, many surrounding communities &mdash; including Independence, Lee&apos;s Summit, and Overland Park (in Kansas) &mdash; have their own licensing or permit requirements. Confirm which jurisdiction your project falls under and verify credentials with that specific authority before signing any contract.
      </p>

      <h2>What insurance should a Missouri plumber carry?</h2>
      <p>
      ...
      <h2>What plumbing work requires a permit in Missouri?</h2>
      <p>
      ...
      <p>
        Ask every plumber for the name and credentials of the licensed individual who will perform the work. In St. Louis and Kansas City, the person on site needs personal credentials &mdash; not just a company license. If the contractor cannot tell you who will be on your project, that is worth pressing before signing anything.
      </p>
