export default function Post() {
  return (
    <>
      <p>
        When a contractor says they&apos;re &ldquo;licensed,&rdquo; that doesn&apos;t necessarily mean they&apos;re licensed for your type of project. Residential and commercial contractor licenses are different credentials with different requirements &mdash; and hiring the wrong type can invalidate your permits, void your insurance, and create serious legal exposure.
      </p>
      <p>
        The distinction matters most when a project crosses the line between the two categories &mdash; a home office addition, a mixed-use building, or a large renovation that triggers commercial code requirements. Understanding what each license covers protects you before work begins.
      </p>

      <h2>What is a commercial contractor license?</h2>
      <p>
      ...
      <p>
        In most states, commercial and residential licenses are separate credentials issued by the same licensing board. A contractor holding only a residential license cannot legally perform commercial work &mdash; and vice versa. Some states use a &ldquo;general contractor&rdquo; license that covers both, but this is not universal. Always verify which category the license covers before signing a contract.
      </p>

      <h2>How does a residential license differ from a commercial one?</h2>
      <p>
        Residential licenses are calibrated to single-family homes and multi-family dwellings up to a certain number of units. They typically require a trade exam focused on residential building codes, smaller bond amounts (often $10,000&ndash;$25,000), and lower insurance minimums. Commercial licenses involve larger bonds, higher liability requirements, and exams covering commercial building codes, which are generally more complex.
      </p>
      <p>
      ...
      <ul>
        <li><strong>Bond amounts:</strong> Commercial licenses typically require bonds of $50,000 or more; residential bonds are often lower.</li>
        <li><strong>Insurance minimums:</strong> Commercial projects require higher liability coverage due to larger project values and more occupants.</li>
        <li><strong>Exam content:</strong> Commercial licensing exams cover IBC, ADA compliance, and commercial-specific safety codes.</li>
      </ul>

      <h2>Does a homeowner ever need to worry about commercial licensing?</h2>
      <p>
      ...
      <p>
        Mixed-use buildings &mdash; a retail space with apartments above &mdash; are particularly complicated. A contractor may need both residential and commercial licensing, or a dual-classification license, depending on which portions of the building they&apos;re working on. Your local building department is the authoritative source on which license is required for your specific project.
      </p>

      <h2>What happens when a residential contractor does commercial work without the right license?</h2>
      <p>
      ...
      <h2>How do I verify which type of license a contractor holds?</h2>
      <p>
