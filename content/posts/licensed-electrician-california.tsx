export default function Post() {
  return (
    <>
      <p>
        Electrical work is one of the most regulated trades in California &mdash; and for good reason. Faulty wiring is a leading cause of residential fires nationwide. Before you hire anyone to work on your home&apos;s electrical system, California law requires that contractor to hold a valid license, and verifying it takes less than two minutes.
      </p>

      <h2>Does California require electricians to be licensed?</h2>
      <p>
        Yes. In California, any electrical contractor performing work valued at $1,000 or more must hold a valid license from the Contractors State License Board (CSLB). The specific classification for electrical work is Class C-10. The licensing threshold was raised from $500 to $1,000 by Assembly Bill 2622, effective June 6, 2026 &mdash; but the exemption only applies when no permit is needed and the person works alone, which effectively excludes all meaningful electrical work. Performing electrical contracting without this license is a misdemeanor, and repeat violations can be charged as a felony.
      </p>
      <p>
      ...
      <h2>What is a Class C-10 electrical license?</h2>
      <p>
      ...
      <h2>How do you verify an electrician&apos;s license in California?</h2>
      <p>
      ...
      <p>
        Always run the lookup the same day you make your hiring decision. License status can change &mdash; a license that was valid when the contractor first quoted your job may have lapsed or been suspended by the time work is scheduled to begin.
      </p>
      <p>
      ...
      <h2>What bond and insurance does a California electrician need?</h2>
      <p>
        All California licensed contractors, including C-10 electrical contractors, are required to maintain a $25,000 contractor&apos;s bond on file with the CSLB (raised from $15,000 to $25,000 by Senate Bill 607 on January 1, 2023). Contractors operating as LLCs must carry an additional $100,000 employee/worker bond and up to $5 million in general liability insurance. You can confirm bond status directly through the CSLB license lookup.
      </p>
      <p>
        In addition to the required bond, electrical contractors working with employees must carry workers&apos; compensation insurance. Starting January 1, 2026, SB 291 makes a valid workers&apos; comp certificate mandatory for CSLB license renewal, with minimum fines of $10,000 for sole owners and $20,000 for others who operate without coverage. Without workers&apos; comp, you as the property owner could be held liable for medical costs if a worker is injured on your property. Always ask for proof of both general liability insurance and workers&apos; comp before work begins.
      </p>

      <h2>What are the risks of hiring an unlicensed electrician?</h2>
      <p>
        The risks of unlicensed electrical work go beyond legal exposure &mdash; they are genuinely dangerous. Unlicensed electricians are not required to follow California&apos;s electrical code, and their work typically won&apos;t pass inspection. Unpermitted electrical work can void your homeowner&apos;s insurance policy and create significant problems when you sell the property.
      </p>
      <p>
        According to the U.S. Fire Administration, electrical fires account for approximately 51,000 home fires each year in the United States. Faulty wiring by unqualified workers is a significant contributing factor. The cost of fixing bad electrical work &mdash; or worse, recovering from a fire &mdash; far exceeds any money saved by hiring cheap, unlicensed labor.
      </p>
      <p>
      ...
      <h2>What else should you check before hiring an electrician?</h2>
      <p>
        Beyond confirming an active C-10 license, review the CSLB record for any disciplinary actions, citations, or civil judgments. A license can be valid while still carrying a history of consumer complaints. Look for patterns &mdash; a single resolved complaint is different from multiple unresolved ones.
      </p>
      <p>
