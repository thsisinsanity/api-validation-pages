export default function Post() {
  return (
    <>
      <p>
        Heating and cooling systems are among the most complex and expensive systems in any home. A poorly installed or improperly repaired HVAC system can lead to carbon monoxide risks, refrigerant leaks, sky-high energy bills, and premature equipment failure. California requires HVAC contractors to be licensed &mdash; and verifying that license before you hire is one of the simplest ways to protect your investment.
      </p>

      <h2>Does California require HVAC contractors to be licensed?</h2>
      <p>
        Yes. Any HVAC contractor performing work valued at $1,000 or more in California must hold a valid license issued by the Contractors State License Board (CSLB). The classification for warm-air heating, ventilating, and air-conditioning work is Class C-20. Assembly Bill 2622 raised the licensing threshold from $500 to $1,000 effective June 5, 2026, but the exemption only applies when no permit is needed and the person works alone &mdash; conditions that never apply to HVAC installations. Operating without a license above the threshold is a misdemeanor, with repeat violations treated as felonies.
      </p>
      <p>
      ...
      <h2>What is a Class C-20 HVAC license?</h2>
      <p>
      ...
      <p>
        The C-20 classification covers furnace installation and repair, central air conditioning, ductwork, heat pumps, mini-splits, and ventilation systems. It does not typically cover boiler work or refrigeration systems used in commercial food service &mdash; those fall under different CSLB classifications.
      </p>
      <p>
      ...
      <h2>How do you verify an HVAC contractor&apos;s license in California?</h2>
      <p>
      ...
      <h2>What bond and insurance does a California HVAC contractor need?</h2>
      <p>
        All CSLB-licensed contractors, including C-20 HVAC contractors, must maintain a $25,000 contractor&apos;s bond (increased from $15,000 on January 1, 2023 under SB 607). This bond is a financial safeguard for consumers &mdash; it can be used to recover losses if the contractor defaults, abandons a project, or causes damage. Bond status is shown in the CSLB license lookup.
      </p>
      <p>
        HVAC contractors with employees must also carry workers&apos; compensation insurance. Starting January 1, 2026, SB 291 requires a valid workers&apos; comp certificate for CSLB license renewal, with minimum fines of $10,000 for sole owners and $20,000 for others who operate without coverage. If a technician is injured while working on your system and the contractor lacks coverage, your homeowner&apos;s insurance may be drawn into the claim. Confirm both general liability and workers&apos; comp coverage before allowing work to begin.
      </p>

      <h2>What are the risks of hiring an unlicensed HVAC contractor?</h2>
      <p>
        HVAC systems involve natural gas, refrigerants, electrical connections, and combustion &mdash; all of which carry serious safety risks when handled improperly. An unlicensed contractor is not required to follow California&apos;s building codes or obtain permits. Unpermitted HVAC installations frequently fail to meet efficiency, safety, and ventilation standards.
      </p>
      <p>
      ...
      <h2>What else should you check before hiring an HVAC contractor?</h2>
      <p>
      ...
      <p>
        Check the CSLB record for disciplinary history, not just active license status. A contractor can hold a valid license while still having a pattern of consumer complaints. Also verify that the technicians performing the refrigerant work hold valid EPA Section 608 certifications &mdash; this is a federal requirement that applies regardless of state licensing.
      </p>
