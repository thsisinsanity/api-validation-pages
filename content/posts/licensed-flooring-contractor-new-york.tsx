export default function Post() {
  return (
    <>
      ...
      <h2>What does the NYC Home Improvement Contractor license require?</h2>
      <p>
      ...
      <h2>Does flooring installation require permits in New York?</h2>
      <p>
        Most residential flooring replacements in New York do not require a building permit. Simple floor covering replacement &mdash; installing hardwood over an existing subfloor, replacing tile, or installing carpet &mdash; typically does not trigger a NYC Department of Buildings permit requirement. However, structural subfloor work, radiant heat installation, or flooring work as part of a larger permitted renovation may require permits.
      </p>
      <p>
      ...
      <h2>What moisture and subfloor considerations matter for New York flooring?</h2>
      <p>
      ...
      <h2>What insurance should a New York flooring contractor carry?</h2>
      <p>
      ...
      <h2>How do you verify a flooring contractor in New York?</h2>
      <p>
      ...
      <h2>What are the risks of hiring an unlicensed flooring contractor in New York?</h2>
      <p>
