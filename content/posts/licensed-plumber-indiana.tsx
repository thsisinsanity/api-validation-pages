export default function Post() {
  return (
    <>
      ...
      <h2>Does Indiana require plumbers to be licensed?</h2>
      <p>
      ...
      <h2>How do I verify a plumber&apos;s license in Indiana?</h2>
      <p>
        Go to pla.in.gov and use the license verification search. Select the license type &mdash; Plumbing Contractor, Master Plumber, or Journeyman Plumber &mdash; and search by name or license number. The results show current license status (active, expired, or revoked), the license number, and the name on the license. An active status with a future expiration date is the minimum you need before signing any contract.
      </p>
      <p>
      ...
      <h2>Does Indiana require plumbing contractors to be bonded?</h2>
      <p>
      ...
      <h2>What are the risks of hiring an unlicensed plumber in Indiana?</h2>
      <p>
        Hiring an unlicensed plumber in Indiana puts your property, your insurance coverage, and your health at risk. Improperly installed plumbing can cause water damage, mold growth, and in the case of gas line work, fire or carbon monoxide hazards. The Insurance Institute reports that water damage is the second most common homeowner insurance claim &mdash; and claims traceable to unlicensed or unpermitted work are frequently denied.
      </p>
      <p>
        Beyond the physical risks, unlicensed plumbing contractors in Indiana have no bond for you to claim against if they abandon a project or do defective work. Your only recourse is civil litigation against an individual who may have no traceable assets. Licensed contractors have a bond, a license to lose, and a regulatory body &mdash; the Indiana Plumbing Commission &mdash; that accepts complaints and can pull credentials.
      </p>

      <h2>What should I check before hiring a plumber in Indiana?</h2>
      <p>
      ...
      <p>
        Payment terms matter as much as credentials. A standard Indiana plumbing contract for a significant job involves payment milestones tied to project completion stages &mdash; not a large upfront payment. Any plumber demanding full payment before work is completed should be treated with caution.
      </p>
