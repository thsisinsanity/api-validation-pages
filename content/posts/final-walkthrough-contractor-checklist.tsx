export default function Post() {
  return (
    <>
      ...
      <h2>What is the purpose of a final walkthrough?</h2>
      <p>
        The final walkthrough is a systematic inspection of completed work against the contract scope before releasing final payment. Its purpose is to identify incomplete items, defective work, damage caused during construction, and any items that don&apos;t match what was specified. These items are compiled into a &ldquo;punch list&rdquo; &mdash; a written list of things to be completed or corrected before final payment is released.
      </p>
      <p>
        The walkthrough should be conducted with the contractor present so items can be identified and acknowledged in real time. Never conduct a walkthrough without your contractor present &mdash; if they can&apos;t claim they saw and agreed to the punch list items, disputes are harder to resolve.
      </p>

      <h2>What should I inspect in each room during a final walkthrough?</h2>
      <p>
      ...
      <p>
        Run all fixtures. Turn on faucets, flush toilets, test the dishwasher, run the garbage disposal, test the range hood. Problems that appear only under use &mdash; slow drains, loose connections, inadequate water pressure &mdash; won&apos;t be visible until systems are actually operated.
      </p>

      <h2>How do I create a punch list from the walkthrough?</h2>
      <p>
      ...
      <p>
        Be specific: &ldquo;Paint touch-up needed on north wall of master bedroom, approximately 2 feet below light switch&rdquo; is more useful than &ldquo;paint needs work.&rdquo; Specificity prevents later disagreement about whether an item was addressed.
      </p>
      <ul>
        <li>Test all doors &mdash; open, close, latch, and lock.</li>
        <li>Test all windows &mdash; open, close, and lock.</li>
        <li>Test all outlets with a small device (phone charger works).</li>
        <li>Run water in all sinks and showers and check for leaks under cabinets.</li>
        <li>Check all light switches and dimmer functions.</li>
        <li>Inspect tile grout and caulk for completeness and consistency.</li>
        <li>Review exterior areas: landscaping restored, construction debris removed, downspouts clear.</li>
      </ul>

      <h2>When should I release final payment after a walkthrough?</h2>
      <p>
        Release final payment only after: all punch list items are satisfactorily completed, all required permits have received final inspection sign-off, you have received all lien waivers from the contractor and major subcontractors, you have received all product documentation (manufacturer warranties, appliance manuals, paint color records), and you are personally satisfied with the work. Do not release final payment before permit final inspection &mdash; many contractors push for payment before the inspector has signed off.
      </p>
      <p>
      ...
      <h2>What recourse do I have if the contractor refuses to address punch list items?</h2>
      <p>
