export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Idaho: How to Verify Before You Hire</h1>

      <p>
        Idaho requires contractors to be licensed by the <strong>Division of Building Safety (DBS)</strong> at dbs.idaho.gov. The DBS licenses public works contractors and has oversight over contractor qualifications for certain project types. Licensed contractors must carry a <strong>$10,000 surety bond</strong>. Idaho&apos;s licensing system is less comprehensive than neighboring states like Washington and Oregon, but verification is still an essential step for Idaho homeowners.
      </p>

      <h2>What Does Idaho&apos;s DBS License Cover?</h2>

      <p>
        Idaho&apos;s DBS primarily licenses public works contractors &mdash; those performing work on government projects. For private residential construction, Idaho&apos;s licensing requirements are more limited than most western states. Idaho does not have a comprehensive private residential contractor licensing program equivalent to Oregon&apos;s CCB or Washington&apos;s L&amp;I registration system. However, the DBS does regulate certain contractor categories and specific trades.
      </p>
      ...
      <h2>What Should Idaho Homeowners Verify When Hiring a GC?</h2>
      ...
      <h2>What Are Idaho&apos;s Building Permit Requirements?</h2>
      ...
      <h2>How Do You Verify an Idaho Contractor&apos;s DBS License?</h2>
