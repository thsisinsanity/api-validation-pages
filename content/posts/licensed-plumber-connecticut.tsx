export default function Post() {
  return (
    <>
      ...
      <h2>Does Connecticut require plumbers to be licensed?</h2>
      <p>
      ...
      <p>
        Connecticut&apos;s plumbing licensing is separate from the HIC registration program that covers general home improvement contractors. A plumber must hold both &mdash; an HIC registration for residential work and the specific plumbing license from DCP. Verify both records separately in the DCP database to confirm full compliance.
      </p>
      <p>
      ...
      <h2>Where do I verify a Connecticut plumber&apos;s license?</h2>
      <p>
      ...
      <h2>What plumber license types exist in Connecticut?</h2>
      <p>
      ...
      <h2>What bond and insurance must Connecticut plumbers carry?</h2>
      <p>
        Connecticut requires HIC-registered plumbing contractors to carry a $15,000 surety bond. The bond is a consumer protection instrument: if the contractor causes damage, fails to complete work, or abandons the project, you can file a claim through the DCP process. Connecticut&apos;s Home Improvement Guaranty Fund provides an additional layer of financial protection, reimbursing homeowners up to $25,000 per eligible claim when a registered contractor defaults. The fund is replenished through annual assessments on all registered contractors.
      </p>
      <p>
      ...
      <h2>What are the penalties for unlicensed plumbing in Connecticut?</h2>
      <p>
