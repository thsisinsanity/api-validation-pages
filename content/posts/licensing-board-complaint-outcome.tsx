export default function Post() {
  return (
    <>
      <p>
        Contractor licensing boards have real power over licensed contractors &mdash; but that power has limits that many homeowners discover only after filing a complaint. Understanding what licensing boards can and cannot do for you helps you deploy the board complaint as one tool in a larger strategy rather than expecting it to be a complete solution.
      </p>
      <p>
      ...
      <h2>What can a contractor licensing board actually do for you?</h2>
      <p>
      ...
      <p>
        Boards can also require the contractor to pay restitution to the homeowner as part of a disciplinary settlement or consent order. This restitution mechanism varies by state but can provide a direct financial recovery path &mdash; particularly in cases where the contractor&apos;s license is a business asset they don&apos;t want to lose, creating leverage for settlement.
      </p>

      <h2>What can a licensing board NOT do for you?</h2>
      <p>
        A licensing board cannot: force a contractor to complete work (they can require correction but not compel ongoing project participation); award compensatory damages the way a court can; operate on the same timeline you might prefer; represent your legal interests; or guarantee that a disciplinary action results in any financial recovery. The board&apos;s mandate is public protection &mdash; their interest in your specific financial harm is instrumental to that mandate, not the primary focus.
      </p>
      <p>
      ...
      <h2>How does board outcome affect my civil case?</h2>
      <p>
      ...
      <p>
        Timing matters: if you are planning civil litigation, consult an attorney before waiting for board findings &mdash; statutes of limitations continue to run regardless of the board investigation.
      </p>

      <h2>How does a board complaint affect contractors who take it seriously?</h2>
      <p>
