export default function Post() {
  return (
    <>
      ...
      <p>
        Most homeowners have heard that contractors are &ldquo;bonded&rdquo; without knowing what that actually means or how to make a claim on the bond.
      </p>

      <h2>What is a contractor bond and what does it cover?</h2>
      <p>
      ...
      <p>
        Bond coverage typically includes: abandonment of a project after collecting payment; failure to pay subcontractors or suppliers; fraud or misrepresentation; and in some states, defective workmanship. Bond amounts vary by state &mdash; California requires a $25,000 contractor license bond; Florida and other states have different minimum amounts. The bond is not unlimited &mdash; claims can collectively exhaust the bond amount.
      </p>

      <h2>How do I find out if a contractor has a bond and who the bonding company is?</h2>
      <p>
        Your state&apos;s contractor licensing board records typically include bond information for licensed contractors. When you verify a contractor&apos;s license, the database often shows the bonding company name, bond amount, and bond expiration date. Ask the contractor directly for their bond certificate &mdash; any properly bonded contractor can produce this document immediately.
      </p>
      <p>
      ...
      <h2>What are the limitations of contractor bond claims?</h2>
      <p>
        Bond claims have several important limitations. First, the bond amount may be insufficient to cover your full loss &mdash; a $25,000 bond can be exhausted across multiple claimants. Second, the bonding company will investigate and may dispute the claim. Third, obtaining the required judgment or board determination takes time. Fourth, once a bond is exhausted, the bonding company owes nothing further.
      </p>
      <p>
      ...
      <h2>What if the contractor has no bond?</h2>
      <p>
