export default function Post() {
  return (
    <>
      ...
      <h2>Does California require landscape contractors to be licensed?</h2>
      <p>
      ...
      <h2>What is the C-27 Landscaping license in California?</h2>
      <p>
      ...
      <h2>Does California require pesticide applicator licensing for landscape contractors?</h2>
      <p>
      ...
      <h2>What are the irrigation contractor requirements in California?</h2>
      <p>
      ...
      <h2>What bond and insurance does a California landscape contractor need?</h2>
      <p>
      ...
      <p>
        The CSLB database also shows whether a contractor has had their license suspended, revoked, or placed on probation. A contractor with a disciplinary history may still have an active license &mdash; the CSLB imposes conditions rather than full revocation in some cases. Review the full record, not just the active/inactive status, before making a hiring decision.
      </p>

      <h2>What happens if you hire an unlicensed landscape contractor in California?</h2>
      <p>
