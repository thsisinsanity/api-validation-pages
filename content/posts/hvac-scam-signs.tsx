export default function Post() {
  return (
    <>
      ...
      <h2>What is the refrigerant (Freon) scam and how does it work?</h2>
      <p>
        The refrigerant scam involves a technician claiming your system is &ldquo;low on Freon&rdquo; and needs to be recharged &mdash; either when it doesn&apos;t, or without diagnosing and repairing the leak that caused the level to drop. A properly functioning sealed refrigerant system does not lose refrigerant over time. If a system is low on refrigerant, there is a leak somewhere &mdash; and recharging without fixing the leak is money wasted.
      </p>
      <p>
      ...
      <h2>What are fake &ldquo;code violation&rdquo; HVAC scams?</h2>
      <p>
      ...
      <h2>How do I find a legitimate HVAC contractor and avoid scams?</h2>
      <p>
