export default function Post() {
  return (
    <>
      ...
      <h2>Does Missouri require electricians to be licensed?</h2>
      <p>
        Missouri does have an optional statewide electrical contractor license
        administered by the Office of Statewide Electrical Contractors under
        the Division of Professional Registration (pr.mo.gov). This statewide
        license allows electrical contractors to operate across Missouri without
        obtaining separate licenses from each city or county. To qualify,
        applicants must pass a nationally accredited electrical assessment exam,
        carry $500,000 in liability insurance, and post a bond with each political
        subdivision where they work. However, the statewide license is voluntary
        &mdash; many contractors hold only local licenses. St. Louis City
        licenses electricians through the St. Louis Building Division. Kansas
        City has its own electrical licensing program. Other cities including
        Springfield, Columbia, and Jefferson City have their own local
        requirements. In rural Missouri, local oversight may be minimal.
      </p>
      <p>
        The absence of a state license does not mean that electrical work in Missouri is unregulated. Local building codes &mdash; most Missouri jurisdictions have adopted the National Electrical Code (NEC) &mdash; still govern how electrical work must be performed. And permits, where required, mandate inspection by a local building authority. The NEC is updated every three years and represents the national standard for safe electrical installations.
      </p>
      <p>
      ...
      <h2>How does electrical licensing work in St. Louis?</h2>
      <p>
      ...
      <h2>How does electrical licensing work in Kansas City?</h2>
      <p>
      ...
      <p>
        Kansas City, Kansas is a separate city with its own licensing requirements and is not covered by the Missouri Kansas City license. Confirm which state and city your project falls under before verifying credentials &mdash; the two cities share a metro area but are governed by different jurisdictions.
      </p>

      <h2>What insurance should a Missouri electrician carry?</h2>
      <p>
        Every Missouri electrician or electrical contractor should carry a minimum of $1 million in general liability insurance and active workers&apos; compensation coverage for all employees. General liability protects your property if the contractor causes damage during the job. Workers&apos; compensation protects you from liability if a worker is injured on your property. Electrical work carries significant injury risk &mdash; the U.S. Bureau of Labor Statistics consistently ranks electrical installation among the higher-risk construction trades.
      </p>
      <p>
        Verify insurance directly. Ask for a certificate of insurance and call the issuing company to confirm both policies are active and not cancelled. A phone call to the insurer takes under five minutes and confirms what the certificate alone cannot &mdash; that the policy has not lapsed since the certificate was printed.
      </p>
      <p>
      ...
      <h2>What happens if electrical work is done without a permit in Missouri?</h2>
      <p>
        Unpermitted electrical work in Missouri cities with permit requirements creates immediate safety risk and long-term legal and financial exposure. Without a permit, no inspection occurs &mdash; meaning there is no independent review of whether the installation meets the National Electrical Code. Faulty wiring that passes undetected can cause fires months or years after the work is completed, by which point the contractor is long gone.
      </p>
      <p>
        For homeowners, unpermitted electrical work creates disclosure obligations at resale. Missouri real estate transactions require disclosure of known material defects, and unpermitted improvements qualify. Buyers&apos; inspectors and attorneys increasingly flag permit history, and the cost of retroactive permitting &mdash; which may require inspection access, documentation, or even partial rework &mdash; typically exceeds the original cost of pulling the permit the first time.
      </p>

      <h2>What should I verify before hiring an electrician in Missouri?</h2>
      <p>
      ...
      <p>
        Ask every contractor for the name of the licensed electrician who will be on site for your job. In St. Louis and Kansas City, the individual performing the work needs to hold personal credentials &mdash; the company license alone does not cover an unlicensed individual doing the hands-on installation. If the contractor cannot name who will be on site, that is a gap worth pressing on.
      </p>
