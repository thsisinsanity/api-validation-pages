export default function Post() {
  return (
    <>
      <p>
        Angi (formerly Angie&apos;s List and merged with HomeAdvisor) is one of the largest contractor lead platforms in the country. Their marketing emphasizes screening and vetting, and they do conduct more verification than most review platforms. But their verification has real gaps &mdash; and understanding what those gaps are helps you know what additional steps to take before hiring anyone you find through Angi.
      </p>
      <p>
      ...
      <h2>How does Angi verify contractor licenses?</h2>
      <p>
        Angi&apos;s screening process includes a check for state contractor licenses as part of onboarding for service professionals. They use third-party verification services to check license status at the time the contractor joins the platform. However, this verification is a point-in-time check &mdash; Angi does not continuously monitor license status after the initial onboarding check.
      </p>
      <p>
        This means a contractor whose license was active when they joined Angi may be operating with an expired, suspended, or revoked license today while still appearing as a vetted Angi Pro. Licenses lapse, get suspended for disciplinary reasons, and get revoked &mdash; and Angi has no automated system to remove contractors whose licenses change status after the initial background check.
      </p>

      <h2>What else does Angi&apos;s contractor screening include?</h2>
      <p>
        Angi&apos;s screening for service professionals includes identity verification, a criminal background check (typically a national criminal database search), and the license check described above. For their &ldquo;Angi Certified&rdquo; tier, additional verification steps are required. They also verify that contractors carry the insurance types required for their trade in their state.
      </p>
      <p>
      ...
      <h2>Has Angi faced criticism for its verification process?</h2>
      <p>
