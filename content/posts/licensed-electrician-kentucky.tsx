export default function Post() {
  return (
    <>
      ...
      <h2>Where do I verify a Kentucky electrician&apos;s license?</h2>
      <p>
      ...
      <p>
        Check both the individual electrician performing the work and the electrical contracting company holding the contract. These are separate licenses. A licensed individual working for an unlicensed company &mdash; or vice versa &mdash; is still a compliance problem that can create issues with inspections and insurance.
      </p>
      <p>
      ...
      <h2>What license classifications do Kentucky electricians hold?</h2>
      <p>
      ...
      <h2>What bond and insurance must Kentucky electricians carry?</h2>
      <p>
        Kentucky requires licensed electrical contractors to carry $500,000 in
        general liability insurance as a condition of KBEE licensure. Electrical
        contractor license renewal costs $200 annually. These requirements
        ensure that contractors have meaningful financial backing behind their
        license.
      </p>
      <p>
        Kentucky requires workers&apos; compensation insurance for all employers
        with one or more employees &mdash; there is no minimum threshold. This
        applies to full-time, part-time, seasonal, and family employees.
        Penalties for operating without coverage in Kentucky are severe: $100
        to $1,000 per employee per day, plus potential business closure and
        criminal charges. Electrical work carries real injury risk &mdash;
        the Electrical Safety Foundation International reports that electrical
        injuries account for hundreds of deaths and thousands of hospitalizations
        among workers annually.
      </p>
      <p>
      ...
      <h2>What are the penalties for unlicensed electrical work in Kentucky?</h2>
      <p>
        Performing unlicensed electrical work in Kentucky is a Class A misdemeanor, which carries criminal penalties including fines and potential incarceration. The KBEE actively investigates complaints and can issue cease-and-desist orders. Beyond the legal consequences for the contractor, work performed without a license often fails inspection &mdash; meaning the work must be redone at your expense.
      </p>
      <p>
