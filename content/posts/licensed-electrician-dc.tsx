export default function Post() {
  return (
    <>
      <h1>How to Find a Licensed Electrician in Washington DC</h1>

      <p>
        In Washington DC, all electricians must hold a <strong>DC Electrical License</strong> issued by the DC Department of Consumer &amp; Regulatory Affairs (DCRA). Electrical work is one of the most strictly regulated trades in the District, and for good reason &mdash; faulty wiring is the leading cause of residential fires. Hiring a licensed electrician protects your property, your family, and your legal standing as a homeowner.
      </p>

      <h2>Who Issues DC Electrical Licenses?</h2>
      ...
      <p>
        DC issues several tiers of electrical license. A <strong>Master Electrician license</strong> is required to run an electrical contracting business and pull permits. A <strong>Journeyman Electrician license</strong> allows an individual to perform electrical work under the supervision of a master. An <strong>Apprentice Electrician</strong> may assist but cannot work independently. When hiring an electrical contractor, verify that the business holds a master electrician license &mdash; not just that one of the employees does.
      </p>

      <p>
        Electrical contractors in DC must also hold a Home Improvement Contractor (HIC) license if they are performing residential work. This dual-licensing requirement is unique to DC and catches many out-of-state electricians who assume their Maryland or Virginia license transfers. It does not &mdash; DC requires DC-specific licensing for all trades.
      </p>

      <h2>What Are the Bond Requirements for DC Electricians?</h2>

      <p>
        All DC home improvement contractors, including licensed electrical contractors, must carry a <strong>$25,000 surety bond</strong>. The bond is filed with the DCRA and provides a financial backstop for consumers if a contractor fails to complete work or causes damage. In addition to the bond, electrical contractors must carry general liability insurance and workers&apos; compensation coverage for any employees.
      </p>
      ...
      <h2>What Penalties Apply to Unlicensed Electrical Work in DC?</h2>

      <p>
        Performing electrical work in DC without a valid license is a serious offense. The DCRA can impose <strong>fines of up to $2,000 per offense</strong>, and repeat violations can result in criminal charges. The DC Attorney General&apos;s office regularly pursues unlicensed contractors, and electrical violations receive priority attention because of the fire risk involved.
      </p>
      ...
      <h2>How Do You Verify a DC Electrician&apos;s License?</h2>
      ...
      <p>
        The right time to verify a DC electrician&apos;s license is before you agree to any work &mdash; not after a deposit is paid. Ask for the master electrician license number, look it up yourself at the DCRA or CheckLicensed.com, and confirm it matches the name on your contract. That two-minute check can save you from months of legal and financial headaches.
      </p>
    </>
  );
}
