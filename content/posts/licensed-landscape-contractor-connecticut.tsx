export default function Post() {
  return (
    <>
      <p>
        Connecticut doesn&apos;t have a single &ldquo;landscape contractor license&rdquo; &mdash; instead, licensing requirements depend on the specific type of work being performed. Whether your landscaper is applying pesticides, building a retaining wall, or installing irrigation, different state agencies may be involved. Understanding which license applies to your project is the first step to hiring safely.
      </p>

      <h2>Does Connecticut require landscape contractors to be licensed?</h2>
      <p>
        It depends on the scope of work. Connecticut does not issue a single statewide &ldquo;landscape contractor&rdquo; license, but most landscaping services trigger at least one licensing requirement. Pesticide and herbicide application requires a DCP license. Hardscaping, grading, and structural work over $200 requires Home Improvement Contractor (HIC) registration. Connecticut leads New England in landscape contractor compliance enforcement, so the requirements are actively monitored.
      </p>
      <p>
      ...
      <h2>When does a landscape contractor need a pesticide license in Connecticut?</h2>
      <p>
      ...
      <h2>When does a landscape contractor need a Home Improvement Contractor license in Connecticut?</h2>
      <p>
      ...
      <h2>How do you verify a landscape contractor&apos;s license in Connecticut?</h2>
      <p>
      ...
      <p>
        Do not rely on a business card or verbal claim of licensure. Connecticut DCP takes unlicensed contracting seriously and the complaint process is accessible &mdash; but only if the contractor was required to be licensed in the first place. Verify before you sign.
      </p>

      <h2>What about irrigation contractors in Connecticut?</h2>
      <p>
      ...
      <p>
        If your landscape project includes irrigation, ask the contractor whether the system will be permitted with your local building department and whether a licensed plumber will handle any potable water connections. An irrigation contractor who dismisses permits as unnecessary is cutting corners that could cause costly problems &mdash; both at installation and when you sell your home.
      </p>

      <h2>What happens if you hire an unlicensed landscape contractor in Connecticut?</h2>
      <p>
        Hiring an unregistered home improvement contractor in Connecticut is a violation of the Home Improvement Act. Contracts with unregistered contractors are unenforceable, which means both parties can face complications &mdash; you may have difficulty recovering damages in court, and the contractor cannot sue to collect payment. DCP can impose civil penalties on unlicensed contractors and pursue restitution on behalf of affected consumers.
      </p>
      <p>
        For pesticide applications performed without proper licensure, the consequences can extend to environmental liability. Improperly applied pesticides can damage neighboring vegetation, contaminate soil, or run off into waterways &mdash; and the homeowner who hired an unlicensed applicator may share liability for the results.
      </p>
