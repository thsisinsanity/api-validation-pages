export default function Post() {
  return (
    <>
      ...
      <h2>Does Connecticut require electricians to be licensed?</h2>
      <p>
        Yes. Connecticut requires electricians to be licensed through the Connecticut Department of Consumer Protection (portal.ct.gov/dcp). The DCP issues licenses for journeyman electricians, master electricians, and electrical contractors. All three license types are required for their respective roles &mdash; a contracting business, the supervising master electrician, and the journeyman performing hands-on work each need their own credential.
      </p>
      <p>
        Connecticut&apos;s DCP also administers the HIC program for general home improvement contractors, but electrical licensing is a separate program with its own requirements and database. An HIC registration does not authorize electrical work &mdash; electrical contractors must also hold the specific electrical license. This distinction matters when verifying a contractor&apos;s qualifications.
      </p>
      <p>
      ...
      <h2>Where do I verify a Connecticut electrician&apos;s license?</h2>
      <p>
      ...
      <h2>What electrician license types does Connecticut issue?</h2>
      <p>
      ...
      <p>
        Some electrical projects require specific endorsements beyond the base license &mdash; for example, work on high-voltage systems or certain commercial applications. Ask the contractor whether their license covers your specific project scope.
      </p>

      <h2>What bond and insurance must Connecticut electricians carry?</h2>
      <p>
        Connecticut requires licensed electrical contractors to carry a $15,000 surety bond, and general liability insurance is required for the electrical license. Workers&apos; compensation is mandatory for all contractors with employees. The bond provides a financial backstop for consumer claims when a contractor fails to complete work or causes damage they refuse to remedy. Connecticut&apos;s Home Improvement Guaranty Fund provides an additional layer of protection, reimbursing homeowners up to $25,000 per eligible claim when a registered contractor causes harm &mdash; but only if the contractor was properly registered at the time of the work.
      </p>
      <p>
        According to the National Fire Protection Association, electrical failures are one of the top causes of residential fires in the United States, responsible for roughly 45,000 home fires per year. Licensed electricians follow National Electrical Code standards enforced through Connecticut&apos;s permit and inspection process &mdash; standards that directly reduce fire risk. Liability insurance covers you when something still goes wrong despite proper installation practices.
      </p>
      <p>
        Verify insurance certificates with the carrier before any work begins.
      </p>

      <h2>What are the penalties for unlicensed electrical work in Connecticut?</h2>
      <p>
