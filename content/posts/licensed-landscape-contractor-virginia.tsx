export default function Post() {
  return (
    <>
      ...
      <h2>Does Virginia require landscape contractors to be licensed?</h2>
      <p>
      ...
      <h2>What license class does a Virginia landscape contractor need?</h2>
      <p>
      ...
      <h2>What is the Virginia pesticide applicator licensing requirement?</h2>
      <p>
      ...
      <h2>What are the irrigation contractor requirements in Virginia?</h2>
      <p>
      ...
      <h2>What bond and insurance amounts should Virginia landscape contractors carry?</h2>
      <p>
      ...
      <p>
        Request a certificate of insurance before any work begins. Confirm the coverage limits are appropriate for your project. Virginia&apos;s minimum insurance requirements for Class B and Class C contractors are relatively modest &mdash; requesting higher limits on larger projects is entirely appropriate and a legitimate contractor will accommodate the request.
      </p>

      <h2>How do you verify a landscape contractor in Virginia?</h2>
      <p>
      ...
      <h2>What are the risks of hiring an unlicensed landscape contractor in Virginia?</h2>
      <p>
