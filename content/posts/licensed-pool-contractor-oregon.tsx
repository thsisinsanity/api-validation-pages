export default function Post() {
  return (
    <>
      <h1>Licensed Pool Contractor in Oregon: How to Verify Before You Hire</h1>
      <p>June 4, 2025 &mdash; 6 min read</p>

      <h2>Does Oregon Require a License to Build a Swimming Pool?</h2>
      <p>
      ...
      <p>
        The CCB exists to protect homeowners. In 2023, the board received thousands of complaints against unlicensed or improperly licensed contractors statewide &mdash; and pool projects ranked among the most expensive disputes, with average complaint values exceeding $20,000. Knowing your contractor is licensed before signing anything is your first and most important protection.
      </p>

      <h2>What License Does a Pool Contractor Need in Oregon?</h2>
      <p>
      ...
      <ul>
        <li><strong>Residential General Contractor:</strong> Covers full residential pool builds including excavation, concrete or fiberglass shell installation, plumbing rough-in, and decking.</li>
        <li><strong>Residential Specialty Contractor:</strong> Covers specific scopes like pool resurfacing, equipment installation, or deck construction without structural work.</li>
        <li><strong>Commercial General Contractor:</strong> Required for pools at hotels, apartment complexes, or commercial recreation facilities.</li>
      </ul>
      <p>
        Plumbing and electrical work connected to the pool &mdash; including pump wiring and bonding &mdash; must be performed by separately licensed plumbers and electricians in Oregon. Your pool contractor may subcontract these trades, but those subs must also hold active Oregon licenses.
      </p>

      <h2>How Much Bond and Insurance Is Required?</h2>
      <p>
      ...
      <p>
        The bond protects you if the contractor abandons the project, causes damage, or violates CCB rules. If a licensed contractor damages your property or fails to complete contracted work, you can file a claim against their bond through the CCB. This process is significantly simpler &mdash; and more likely to result in compensation &mdash; than suing an unlicensed contractor in civil court.
      </p>
      <p>
      ...
      <h2>How Do You Verify a Pool Contractor&apos;s License in Oregon?</h2>
      <p>
      ...
      <ul>
        <li><strong>Active status:</strong> The license must be current, not expired or suspended.</li>
        <li><strong>License type match:</strong> The category should cover the work you&apos;re hiring for (residential vs. commercial, general vs. specialty).</li>
        <li><strong>Bond in force:</strong> Confirm the bond is active and not lapsed.</li>
        <li><strong>No unresolved complaints:</strong> The CCB records complaints and arbitration history publicly.</li>
      </ul>
      <p>
      ...
      <h2>What Are the Risks of Hiring an Unlicensed Pool Contractor in Oregon?</h2>
      <p>
      ...
      <ul>
        <li><strong>Failed inspections:</strong> Pool construction requires permits and inspections in Oregon. Unlicensed contractors often skip permits, leaving you with illegal construction you may need to demolish or correct at your own expense.</li>
        <li><strong>No bond protection:</strong> If an unlicensed contractor disappears mid-project or causes property damage, your only option is civil litigation &mdash; which is slow, expensive, and uncertain.</li>
        <li><strong>Electrical safety hazards:</strong> Improperly bonded or wired pool equipment is a drowning and electrocution risk. Oregon electrical codes for pools are strict for good reason.</li>
        <li><strong>Homeowner liability:</strong> If a guest is injured in a pool with faulty unlicensed construction, your homeowner&apos;s insurance may deny the claim.</li>
      </ul>
      <p>
      ...
      <h2>What Permits Does Pool Construction Require in Oregon?</h2>
      <p>
      ...
      <p>
        Your licensed CCB contractor should handle permit applications as part of the project. If a contractor asks you to pull permits yourself &mdash; or tells you permits &quot;aren&apos;t necessary&quot; for a pool &mdash; treat that as a serious warning sign. Only licensed contractors can legally apply for permits on behalf of the property owner for construction work in Oregon.
      </p>
      <p>
