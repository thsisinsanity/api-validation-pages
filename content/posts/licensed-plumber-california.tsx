export default function Post() {
  return (
    <>
      <p>
        Plumbing failures are among the most costly home repair problems in California. Water damage, sewage backups, and failed pipes can cause tens of thousands of dollars in damage &mdash; and hiring an unlicensed plumber dramatically increases the chances of that outcome. California law requires plumbers to be licensed, and verifying that license is quick and free.
      </p>

      <h2>Does California require plumbers to be licensed?</h2>
      <p>
        Yes. Any plumbing contractor performing work valued at $1,000 or more in California must hold a valid license from the Contractors State License Board (CSLB). The classification for plumbing contractors is Class C-36. As of June 5, 2026, Assembly Bill 2622 raised the threshold from $500 to $1,000 &mdash; but the exemption only applies when no building permit is required and no workers are employed, conditions that virtually never apply to plumbing. The threshold applies to the total value of the job, including both labor and materials.
      </p>
      <p>
        Performing plumbing work without a license above this threshold is a misdemeanor under California law. Repeat violations can be escalated to felony charges. Starting July 1, 2026, SB 779 raises the minimum civil penalty for unlicensed work from $200 to $1,500. The CSLB&apos;s SWIFT team actively investigates unlicensed activity &mdash; in 2024, they conducted 46 sweep operations across 17 counties, resulting in over 229 legal actions against unlicensed contractors statewide.
      </p>

      <h2>What is a Class C-36 plumbing license?</h2>
      <p>
      ...
      <h2>How do you verify a plumber&apos;s license in California?</h2>
      <p>
      ...
      <h2>What bond and insurance does a California plumber need?</h2>
      <p>
        All CSLB-licensed contractors, including C-36 plumbers, must maintain a $25,000 contractor&apos;s bond (raised from $15,000 to $25,000 on January 1, 2023 under SB 607). Contractors operating as LLCs face additional requirements: a $100,000 employee/worker bond and up to $5 million in general liability insurance. Bond status is visible in the CSLB license lookup record.
      </p>
      <p>
        Beyond the mandatory bond, plumbing contractors with employees are required to carry workers&apos; compensation insurance. Without it, a worker injured on your property could result in a claim against your homeowner&apos;s insurance &mdash; or a lawsuit against you personally. Ask for certificates of insurance before authorizing any work to begin.
      </p>
      <p>
        General liability insurance is not mandated by state law but is strongly advisable. Water damage caused by poor workmanship can be expensive, and you want the contractor&apos;s liability coverage to pay for it &mdash; not yours.
      </p>

      <h2>What are the risks of hiring an unlicensed plumber?</h2>
      <p>
      ...
      <h2>What else should you check before hiring a plumber?</h2>
      <p>
      ...
      <p>
        For jobs involving new gas lines or gas appliance installations, confirm the contractor has specific experience with gas work &mdash; it falls under the C-36 scope but requires particular expertise. Ask directly about their experience with the type of work you need done.
      </p>
