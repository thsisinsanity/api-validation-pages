export default function Post() {
  return (
    <>
      <p>
        New York&apos;s electrical licensing system is more fragmented than most states &mdash; licensing authority is split between the state Department of Labor, local municipalities, and New York City&apos;s own licensing structure. Before you hire any electrician in New York, you need to understand which licenses apply to your location and how to verify them. Getting this wrong is expensive and dangerous.
      </p>

      <h2>Does New York require a license for electricians?</h2>
      <p>
        Yes, but the specific license required depends heavily on where the work is being performed. New York State licenses master electricians through the Department of Labor for certain work types, but many cities and counties &mdash; including New York City, Buffalo, and Yonkers &mdash; have their own separate electrical licensing requirements that go beyond the state system.
      </p>
      <p>
      ...
      <h2>How do you verify an electrician&apos;s license in New York?</h2>
      <p>
      ...
      <h2>What bond and insurance does a New York electrician need?</h2>
      <p>
      ...
      <h2>Does electrical work in New York require a permit?</h2>
      <p>
        Yes. In New York, most electrical work &mdash; new circuits, panel upgrades, service changes, and major repairs &mdash; requires a permit and inspection from the local building authority. In New York City, permits are issued through the DOB and require a licensed master electrician to be the contractor of record.
      </p>
      <p>
      ...
      <h2>What is the difference between a master electrician and a journeyman in New York?</h2>
      <p>
        In New York, a master electrician holds an independent license authorizing them to contract for and supervise electrical work. A journeyman electrician is a skilled worker who performs electrical work under the supervision of a licensed master. The contractor you hire must be a licensed master &mdash; journeymen cannot independently contract for or supervise electrical projects.
      </p>
      <p>
