export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Kentucky: How to Verify Before You Hire</h1>

      <p>
        Kentucky requires residential contractors to be licensed by the <strong>Kentucky Department of Housing, Buildings and Construction (HBC)</strong> at hbc.ky.gov. Licensing is required for projects exceeding <strong>$10,000</strong>. Licensed contractors must carry a <strong>$10,000 surety bond</strong>. Kentucky&apos;s HBC database is searchable online, allowing homeowners to verify license status before hiring.
      </p>

      <h2>What Is Kentucky&apos;s Residential Contractor License?</h2>
      ...
      <p>
        The HBC also issues specialty trade licenses for electrical, plumbing, HVAC, and other trades within the residential licensing framework. These specialty licenses require separate exams and credentials. A general residential contractor managing a multi-trade project in Kentucky must use HBC-licensed specialty subcontractors for regulated trades &mdash; a licensed GC cannot self-perform specialty work without the corresponding specialty endorsement.
      </p>

      <h2>What Is Kentucky&apos;s $10,000 Contractor Licensing Threshold?</h2>
      ...
      <p>
        Kentucky&apos;s construction market has seen significant growth, particularly in Louisville and Lexington, driven by economic development and population growth. The growth in demand has attracted contractors from across the region, some of whom may not hold Kentucky-specific credentials. Always verify that a contractor holds an active Kentucky HBC license &mdash; a license from Ohio, Tennessee, or another neighboring state does not automatically transfer.
      </p>

      <h2>What Bond and Insurance Does a Kentucky Contractor Need?</h2>

      <p>
        Kentucky requires HBC licensees to carry a <strong>$10,000 surety bond</strong> and general liability insurance. The bond protects homeowners if a contractor fails to complete a project or causes damage. General liability insurance minimums for Kentucky residential contractors are typically $300,000 to $500,000 per occurrence, though larger projects should require more.
      </p>
      ...
      <h2>How Do You Verify a Kentucky Contractor&apos;s License?</h2>
