export default function Post() {
  return (
    <>
      <h1>Licensed General Contractor in Rhode Island: How to Verify Before You Hire</h1>

      <p>
        Rhode Island requires contractors to be licensed by the <strong>Contractors&apos; Registration and Licensing Board (CRB)</strong> at crb.ri.gov. The CRB licenses home improvement contractors and requires a <strong>$10,000 surety bond</strong>. Rhode Island&apos;s CRB registration is one of the primary consumer protection mechanisms for homeowners in the Ocean State.
      </p>

      <h2>What Is Rhode Island&apos;s CRB Registration?</h2>
      ...
      <p>
        Rhode Island&apos;s CRB registration is not a skills-based exam license &mdash; contractors do not need to pass a trade test to obtain registration. However, the CRB registration creates legal accountability through the bond and insurance requirements, and gives homeowners a formal complaint channel if a contractor fails to perform. The CRB actively investigates consumer complaints and can revoke registrations.
      </p>
      ...
      <h2>What Does Rhode Island&apos;s $10,000 Bond Cover?</h2>

      <p>
        Rhode Island&apos;s <strong>$10,000 bond</strong> protects homeowners if a CRB-registered contractor abandons a project, fails to complete work, or causes damage. The bond can be claimed through the CRB&apos;s complaint process. Rhode Island also has a Home Repair Fraud Prevention Act that provides additional legal remedies for homeowners defrauded by contractors.
      </p>
      ...
      <h2>What Are Rhode Island&apos;s Home Improvement Contract Requirements?</h2>
      ...
      <p>
        Rhode Island prohibits contractors from requiring more than one-third of the contract price as a down payment before work begins. This requirement is particularly important for Rhode Island homeowners to know &mdash; a contractor demanding 50% upfront before touching a tool is in potential violation of state law. Any payment demand that exceeds one-third of the total contract should be questioned and documented.
      </p>

      <h2>How Do You Verify a Rhode Island Contractor&apos;s Registration?</h2>

      <p>
        Search the CRB database at crb.ri.gov by contractor name, registration number, or city. Confirm the registration status is &ldquo;active,&rdquo; the expiration date is current, and the bond is on file. Also review any disciplinary history in the CRB record.
      </p>
