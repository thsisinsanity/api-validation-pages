export default function Post() {
  return (
    <>
      ...
      <h2>How Do You Verify a Pool Contractor&apos;s Credentials in Idaho?</h2>
      <p>
        Because there is no statewide pool contractor license in Idaho, verification requires multiple steps. Start with your local building department to confirm permit history &mdash; any reputable contractor will have a track record of pulling permits and passing inspections.
      </p>
      <p>
      ...
      <h2>What Permits Are Required for Pool Construction in Idaho?</h2>
      <p>
      ...
      <h2>What Should an Idaho Pool Contract Include?</h2>
      <p>
      ...
      <h2>How Can CheckLicensed Help Idaho Homeowners?</h2>
      <p>
        In a state without mandatory pool contractor licensing, verifying the credentials that do exist &mdash; like electrician and plumber licenses &mdash; is essential. CheckLicensed.com makes it fast and affordable to confirm that the tradespeople involved in your pool project hold valid Idaho state licenses. For $25 per check, you can verify credentials before work begins and keep a record of your due diligence.
      </p>
  </>
  );
}
