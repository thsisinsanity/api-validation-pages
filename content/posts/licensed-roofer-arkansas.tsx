export default function Post() {
  return (
    <>
      ...
      <h2>Where do I verify an Arkansas roofer&apos;s license?</h2>
      <p>
      ...
      <p>
        Arkansas sees post-storm contractor surges after tornadoes and severe weather. Always verify that a contractor is licensed in Arkansas &mdash; a license from another state does not authorize work here.
      </p>

      <h2>What contractor classifications apply to Arkansas roofers?</h2>
      <p>
        Arkansas&apos;s ACLB issues licenses under residential and commercial contractor categories, with roofing classified as a specialty trade. Contractors must be licensed in the appropriate category for their project type. The license also specifies a project value limit &mdash; a contractor licensed for projects up to $250,000 cannot legally take on a $500,000 roofing contract. Verify both the classification and the project limit.
      </p>
      <p>
      ...
      <h2>What bond and insurance must Arkansas roofers carry?</h2>
      <p>
        Arkansas requires residential roofing contractors to carry a $15,000 surety bond. The residential roofing contractor registration is required for contractors performing more than $2,000 of roofing work, a threshold well below the general ACLB $20,000 licensing requirement. Commercial contractors need a separate $10,000 surety bond. The bond provides a consumer protection mechanism enabling claims when a licensed contractor causes damage, abandons a project, or refuses to remedy defective work. The ACLB accepts complaints and can facilitate bond claims for homeowners who hired licensed contractors.
      </p>
      <p>
        Beyond the bond, roofing contractors should carry general liability insurance and workers&apos; compensation. Arkansas sees regular tornado and severe hail activity &mdash; roofing demand spikes after storms, and so does contractor fraud. The National Insurance Crime Bureau identifies post-storm roofing scams as one of the most common contractor fraud patterns in states with active severe weather seasons. Insurance verification is your financial protection if a contractor takes your deposit and disappears.
      </p>
      <p>
        Request certificates of insurance and verify them with the issuing carrier before any work starts.
      </p>

      <h2>What are the penalties for unlicensed roofing in Arkansas?</h2>
      <p>
      ...
      <p>
        For homeowners, the consequences include no bond claim, no ACLB dispute process, failed inspections, and the full cost of corrective work out of pocket. Arkansas&apos;s $1,000 fine for unlicensed work is a deterrent aimed at the contractor &mdash; but only verification before hiring protects the homeowner.
      </p>

      <h2>What else should I check before hiring an Arkansas roofer?</h2>
      <p>
