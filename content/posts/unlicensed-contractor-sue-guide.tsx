export default function Post() {
  return (
    <>
      ...
      <p>
        In some states, the law is actually more favorable to homeowners when an unlicensed contractor is involved &mdash; you may be entitled to recover all money paid regardless of work quality.
      </p>

      <h2>What legal options do I have against an unlicensed contractor?</h2>
      <p>
      ...
      <p>
        In several states &mdash; including California, Louisiana, and others &mdash; statutes specifically allow homeowners who hired unlicensed contractors to recover all compensation paid, regardless of whether the work was competently performed. California Business and Professions Code &sect;7031 is the most sweeping version: it allows full recovery of all money paid to an unlicensed contractor as a matter of law. This is a significant advantage that many homeowners don&apos;t know about.
      </p>

      <h2>How does jurisdiction-specific law affect my case?</h2>
      <p>
      ...
      <h2>What documentation do I need to sue an unlicensed contractor?</h2>
      <p>
      ...
      <p>
        The evidence of unlicensed status is critical &mdash; in states with strong unlicensed contractor statutes, proving they lacked a license may be most of your case. A current screenshot from the state database or a report from <strong>CheckLicensed.com</strong> documents this cleanly.
      </p>

      <h2>What are the realistic challenges of collecting a judgment from an unlicensed contractor?</h2>
      <p>
        Winning a judgment is only the first step &mdash; collecting it is the second, and often harder, step. Unlicensed contractors frequently operate with minimal documented assets. They may not have business bank accounts, real property, or traceable income. Judgment collection tools &mdash; bank levies, wage garnishments, property liens &mdash; require locating attachable assets.
      </p>
      <p>
