export default function Post() {
  return (
    <>
      <h1>How to Find a Licensed HVAC Contractor in Washington DC</h1>

      <p>
        Washington DC requires HVAC contractors to hold a <strong>DC Refrigeration/HVAC license</strong> issued by the DC Department of Consumer &amp; Regulatory Affairs (DCRA). HVAC work in the District &mdash; including installation, repair, or replacement of heating, cooling, and refrigeration systems &mdash; is a licensed trade subject to DC building code requirements and permit obligations. Unlicensed HVAC work is illegal in DC and exposes homeowners to significant risk.
      </p>

      <h2>Who Issues HVAC Licenses in Washington DC?</h2>

      <p>
        The DCRA&apos;s Business &amp; Professional Licensing Administration issues DC Refrigeration/HVAC licenses. Like other licensed trades in DC, HVAC licensing has tiered levels: <strong>Master</strong>, <strong>Journeyman</strong>, and <strong>Apprentice</strong>. A master HVAC license holder is required to pull permits and operate an HVAC contracting business. Verify any HVAC contractor&apos;s license at dcra.dc.gov or permits.dc.gov.
      </p>
      ...
      <h2>What Does the $25,000 Bond Cover for DC HVAC Contractors?</h2>

      <p>
        DC HVAC contractors must carry a <strong>$25,000 surety bond</strong> as part of their HIC license. The bond guarantees that if a contractor fails to complete your HVAC installation, abandons a project, or causes damage through faulty work, you have a financial recovery mechanism. Bond claims can be filed through the DCRA when a contractor cannot or will not make you whole.
      </p>

      <p>
        HVAC projects in Washington DC can cost anywhere from $3,000 for a basic repair to $15,000 or more for a full system replacement in a multi-zone row house. At those price points, the $25,000 bond provides meaningful protection. Before any HVAC contractor begins work, confirm their bond is active by checking the DCRA licensing database &mdash; not just by taking the contractor&apos;s word for it.
      </p>

      <h2>Why Does HVAC Licensing Matter in DC&apos;s Climate?</h2>

      <p>
        Washington DC experiences both extreme summer heat and cold winters, making HVAC systems critical infrastructure for DC homes. The National Weather Service regularly issues heat advisories for DC during July and August, with heat indices exceeding 105&deg;F. A failed HVAC installation isn&apos;t just an inconvenience &mdash; it can be a health emergency for elderly residents or young children. Proper installation by a licensed contractor following DC code is essential.
      </p>
