export default function Post() {
  return (
    <>
      ...
      <h2>Does Tennessee require plumbers to be licensed?</h2>
      <p>
      ...
      <h2>What types of plumbing licenses does Tennessee issue?</h2>
      <p>
      ...
      <p>
        When hiring a plumbing company, the business must employ a licensed Master Plumber responsible for all work performed. When you verify credentials, confirm that the master plumber of record for your specific job holds an active license &mdash; not just that someone in the company does.
      </p>

      <h2>How do you verify a plumber&apos;s license in Tennessee?</h2>
      <p>
      ...
      <h2>What bond and insurance should a Tennessee plumber carry?</h2>
      <p>
        Tennessee requires licensed plumbing contractors to post a $10,000 surety bond as a condition of licensing. Tennessee also issues a Limited Licensed Plumber (LLP) credential for smaller plumbing projects, which requires workers&apos; compensation insurance or a formal exemption. Note that bond and licensing requirements vary by municipality &mdash; cities like Knoxville and Gallatin require their own separate $10,000 contractor license bonds for plumbing permits. The bond provides limited financial recourse if a contractor fails to complete work or causes unremedied damage. For larger plumbing jobs, you should also require general liability insurance beyond the bond.
      </p>
      <p>
        Ask for a certificate of insurance showing active general liability coverage and workers&apos; compensation insurance before work begins. Call the insurer to confirm both policies are currently in force. Workers&apos; comp coverage is essential &mdash; a plumber injured in your home while working for an uninsured contractor could expose you to significant legal and financial liability.
      </p>

      <h2>What are the risks of hiring an unlicensed plumber in Tennessee?</h2>
      <p>
      ...
      <p>
        CheckLicensed.com makes Tennessee plumber verification fast and easy. For $25, you get an instant report on any contractor&apos;s license status, type, and expiration &mdash; so you can hire with full confidence. Visit CheckLicensed.com before your next plumbing project.
      </p>
    </>
  );
}
