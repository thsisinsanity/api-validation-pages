export default function Post() {
  return (
    <>
      ...
      <p>
        TDLR regulates multiple tiers of electrical licensing in Texas, including Apprentice Electricians, Journeyman Electricians, Master Electricians, and Electrical Contractors. Electrical Contractor license numbers follow the format &quot;TECL&quot; followed by a numeric sequence (e.g., TECL 12345). For hiring purposes, the Electrical Contractor license is the business-level credential you should verify before signing a contract.
      </p>

      <h2>What types of electrical licenses does Texas issue?</h2>
      <p>
      ...
      <h2>How do you verify an electrician&apos;s license in Texas?</h2>
      <p>
      ...
      <p>
        Always verify on the day you plan to hire, not just when you receive the initial quote. License status can change &mdash; licenses expire, get suspended for exam or continuing education failures, or get revoked for disciplinary reasons. A license that was active six months ago may not be active today.
      </p>
      <p>
      ...
      <h2>What insurance should a Texas electrician carry?</h2>
      <p>
        Texas does not mandate general liability insurance for licensed electrical contractors at the state level, but most reputable firms carry it voluntarily. Industry standard in Texas metro areas like Houston, Dallas-Fort Worth, and San Antonio is at least $1 million per occurrence. At minimum, ask for proof of general liability coverage before any work begins. This protects you if the contractor&apos;s work damages your property or causes an injury.
      </p>
      <p>
        Workers&apos; compensation insurance is particularly important in Texas, because Texas is the only state that does not require most private employers to carry it. Employers who opt out are known as &quot;non-subscribers&quot; under Texas law and lose certain legal defenses if a worker is injured. If an electrician is injured on your property and the contractor has no workers&apos; comp, you may face legal and financial exposure. Always ask specifically whether the contractor carries workers&apos; compensation and verify it with the insurer.
      </p>

      <h2>What are the risks of hiring an unlicensed electrician in Texas?</h2>
      <p>
      ...
      <p>
        If you discover after the fact that a contractor was unlicensed, you can file a complaint with the Texas Attorney General&apos;s consumer protection division. However, recovering money from an unlicensed operator is difficult &mdash; prevention is far more effective.
      </p>
