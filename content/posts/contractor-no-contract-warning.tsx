export default function Post() {
  return (
    <>
      <p>
        A contractor who refuses to put the agreement in writing is a contractor who doesn&apos;t want a written record of their commitments. This is a serious red flag regardless of how personable they are, how competitive their price is, or how many neighbors have used them. The absence of a written contract is not a sign of simplicity or efficiency &mdash; it is a sign of someone who expects to dispute what was agreed to.
      </p>
      <p>
      ...
      <h2>Why does refusing a written contract signal problems?</h2>
      <p>
        A written contract protects both parties by documenting exactly what was agreed. A contractor who resists one is almost always signaling one of three things: they intend to deliver less than what was discussed verbally; they plan to add costs the homeowner didn&apos;t anticipate; or they know the terms they are offering won&apos;t look good on paper. Legitimate, professional contractors use written contracts routinely because contracts protect them too &mdash; from scope creep, payment disputes, and miscommunication.
      </p>
      <p>
        State licensing boards regularly receive complaints in which a homeowner claims the contractor didn&apos;t do what was agreed, and the contractor claims the homeowner is misremembering the scope. Without a written contract, these disputes almost always favor the contractor &mdash; because there is no documentation of what was promised.
      </p>

      <h2>What must a contractor contract include?</h2>
      <p>
      ...
      <h2>What are the common excuses contractors use to avoid a written contract?</h2>
      <p>
        Common avoidance tactics include: &ldquo;We work on trust around here,&rdquo; &ldquo;I&apos;ve been doing this for 30 years on a handshake,&rdquo; &ldquo;The paperwork just slows us down,&rdquo; and &ldquo;My lawyer says I shouldn&apos;t put things in writing.&rdquo; None of these are legitimate justifications. The first two are social pressure. The third is false &mdash; experienced contractors use contracts because they prevent disputes, not because paperwork is enjoyable. The fourth is either a lie or a reason to find a different contractor.
      </p>
      <p>
      ...
      <h2>What should I do if a contractor starts work without a signed contract?</h2>
      <p>
      ...
      <h2>Does a contractor&apos;s license affect the enforceability of their contracts?</h2>
      <p>
